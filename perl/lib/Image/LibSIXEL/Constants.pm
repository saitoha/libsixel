...
our @EXPORT_OK = qw(
    ...
    SIXEL_OPTFLAG_DIFFUSION_SCAN
    SIXEL_OPTFLAG_DIFFUSION_CARRY
    SIXEL_OPTFLAG_FIND_LARGEST
    SIXEL_OPTFLAG_SELECT_COLOR
    SIXEL_OPTFLAG_QUANTIZE_MODEL
    SIXEL_OPTFLAG_FINAL_MERGE
    SIXEL_OPTFLAG_CROP
    SIXEL_OPTFLAG_WIDTH
...
use constant {
    ...
    SIXEL_OPTFLAG_DIFFUSION_SCAN => 'y',
    SIXEL_OPTFLAG_DIFFUSION_CARRY => 'Y',
    SIXEL_OPTFLAG_FIND_LARGEST => 'f',
    SIXEL_OPTFLAG_SELECT_COLOR => 's',
    SIXEL_OPTFLAG_QUANTIZE_MODEL => 'Q',
    SIXEL_OPTFLAG_FINAL_MERGE => 'F',
