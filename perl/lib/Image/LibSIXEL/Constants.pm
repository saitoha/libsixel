...
use constant {
    ...
    SIXEL_ALPHA_POLICY_COMPOSITE => 0,
    SIXEL_ALPHA_POLICY_CLEAR => 1,
    SIXEL_ALPHA_POLICY_KEEP => 2,
    SIXEL_ALPHA_POLICY_AUTO => 3,
