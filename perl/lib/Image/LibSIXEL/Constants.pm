...
our @EXPORT_OK = qw(
    ...
    SIXEL_GPU_POLICY_AUTO
    SIXEL_GPU_POLICY_FORCE
    ...
    SIXEL_BUILTIN_G4
    SIXEL_BUILTIN_G8
    SIXEL_BUILTIN_OKLCH_LATTICE256
    ...
    SIXEL_OPTFLAG_HELP
    SIXEL_DECODE_PIXELS_OPTION_TRUST_RASTER_SIZE
    SIXEL_DECODE_PIXELS_RESULT_ALPHA_OPAQUE
    SIXEL_DECODE_PIXELS_RESULT_PAINT_OUTSIDE_RASTER
    SIXEL_DECODE_PIXELS_RESULT_CLIPPED_TO_RASTER
    SIXEL_DECODE_PIXELS_RESULT_PALETTE_REDEFINED
    SIXEL_HAVE_DECODE_PIXELS_BODY
    SIXEL_HAVE_FRAME_INIT_BORROWED
    ...
    SIXEL_HAVE_ENCODER_6DELTA_PLANE
    SIXEL_HAVE_ENCODER_ENCODE_FRAME
    SIXEL_HAVE_DECODER_DECODE_PIXELS
);

# Auto-generated from include/sixel.h. Do not edit manually.
use constant {
    SIXEL_INTERNAL_API => 'SIXELAPI',
    LIBSIXEL_VERSION => '1.11.1-pre1',
    LIBSIXEL_ABI_VERSION => '1:8:0',
    ...
    SIXEL_GPU_POLICY_OFF => 0,
    SIXEL_GPU_POLICY_AUTO => 1,
    SIXEL_GPU_POLICY_FORCE => 2,
    ...
    SIXEL_BUILTIN_G4 => 8,
    SIXEL_BUILTIN_G8 => 9,
    SIXEL_BUILTIN_OKLCH_LATTICE256 => 10,
    ...
    SIXEL_DEQUANTIZE_SELECTIVE_BLUR => 3,
    ...
    SIXEL_TRANSPARENT_POLICY_BACKGROUND => 0,
    SIXEL_TRANSPARENT_POLICY_CLEAR => 1,
    SIXEL_TRANSPARENT_POLICY_TRANSPARENT => 2,
    ...
    SIXEL_OPTFLAG_SAMPLING_POLICY => 256,
    SIXEL_OPTFLAG_BINNING_POLICY => 257,
    SIXEL_OPTFLAG_MERGE_POLICY => 'F',
    SIXEL_OPTFLAG_COVER_POLICY => 'a',
    ...
    SIXEL_OPTFLAG_LUT_POLICY => '~',
    SIXEL_OPTFLAG_GPU_POLICY => 'G',
    SIXEL_OPTFLAG_RUNTIME_POLICY => 'j',
    SIXEL_OPTFLAG_DIAGNOSTICS => 'x',
    SIXEL_OPTFLAG_LOG_PATH => 'J',
    SIXEL_OPTFLAG_CLIPBOARD_POLICY => 'y',
    SIXEL_OPTFLAG_TERMINAL_POLICY => 'z',
    ...
    SIXEL_DECODE_PIXELS_RESULT_PALETTE_REDEFINED => 8,
    SIXEL_HAVE_DECODE_PIXELS_BODY => 1,
    SIXEL_HAVE_FRAME_INIT_BORROWED => 1,
    ...
    SIXEL_HAVE_ENCODER_6DELTA_PLANE => 1,
    SIXEL_HAVE_ENCODER_ENCODE_FRAME => 1,
    SIXEL_HAVE_DECODER_DECODE_PIXELS => 1,
};
