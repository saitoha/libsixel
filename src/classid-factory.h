...
#endif
#if 1
# define SIXEL_FACTORY_CLASSID_CREATE_66 sixel_loader_manager_new
#else
# define SIXEL_FACTORY_CLASSID_CREATE_66 0
#endif
#if 1
# define SIXEL_FACTORY_CLASSID_CREATE_67 sixel_timeline_logger_factory_new
#else
...
#line 463 "src/classid-factory.gperf"
    {"loader/manager", SIXEL_FACTORY_CLASSID_CREATE_66},
    {"", 0}, {"", 0},
#line 464 "src/classid-factory.gperf"
    {"diagnostics/timeline-logger", SIXEL_FACTORY_CLASSID_CREATE_67},
