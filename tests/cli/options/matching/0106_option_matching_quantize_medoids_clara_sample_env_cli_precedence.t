#!/bin/sh
# TAP test verifying medoids clara_sample accepts env/CLI values and keeps CLI priority.
...
echo "ok" 1 - "medoids clara_sample follows env/CLI acceptance and CLI priority"
exit 0
