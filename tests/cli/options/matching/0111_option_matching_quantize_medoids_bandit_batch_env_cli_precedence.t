#!/bin/sh
# TAP test verifying kmedoids bandit_batch accepts env/CLI values and keeps CLI priority.
...
echo "ok" 1 - "kmedoids bandit_batch follows env/CLI acceptance and CLI priority"
exit 0
