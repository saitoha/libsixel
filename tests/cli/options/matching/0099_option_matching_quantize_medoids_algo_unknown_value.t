...
msg=$(set +xv; ${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" -Qmedoids:a=invalid "${TOP_SRCDIR}/tests/data/inputs/small.ppm" -o/dev/null 2>&1) && {
...
test "${msg#*valid values*auto, pam, sample, random, bandit*}" != "${msg}" || {
