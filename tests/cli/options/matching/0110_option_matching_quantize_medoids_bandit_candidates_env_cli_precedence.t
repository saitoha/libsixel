#!/bin/sh
# TAP test verifying kmedoids bandit_candidates accepts env/CLI values and keeps CLI priority.
...
${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" \
    -Qkmedoids:bandit_candidates=4096 \
    "${TOP_SRCDIR}/tests/data/inputs/small.ppm" \
    -o/dev/null >/dev/null 2>&1 || {
...
echo "ok" 1 - "kmedoids bandit_candidates follows env/CLI acceptance and CLI priority"
exit 0
