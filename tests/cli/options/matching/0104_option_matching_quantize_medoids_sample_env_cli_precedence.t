#!/bin/sh
# TAP test verifying kmedoids sample accepts env/CLI values and keeps CLI priority.
...
echo "ok" 1 - "kmedoids sample follows env/CLI acceptance and CLI priority"
exit 0
