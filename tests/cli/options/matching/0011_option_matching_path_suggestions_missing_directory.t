...
run_img2sixel --env SIXEL_OPTION_PATH_SUGGESTIONS=1 --     -m "${ARTIFACT_LOCAL_DIR}/not-there/map.gpl"     "${TOP_SRCDIR}/tests/data/inputs/snake_64.png"     >"${out_file}" 2>"${err_file}" && {
