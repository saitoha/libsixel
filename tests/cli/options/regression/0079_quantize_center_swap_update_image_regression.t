...
test "${short_trace#*LSXSUB1|*key=swap_update|stored=1|binding=quantize_model_kcenter_swap_update,quantize_model_kcenter_swap_update_override*}" != "${short_trace}" || {
...
test "${env_trace#*LSXSUB1|*key=swap_update|stored=1|binding=quantize_model_kcenter_swap_update,quantize_model_kcenter_swap_update_override*}" != "${env_trace}" || {
