...
test "${short_trace#*LSXSUB1|*key=bmp_info40_mode|stored=1|binding=builtin_bmp_info40_mode*}" != "${short_trace}" || {
...
test "${env_trace#*LSXSUB1|*key=bmp_info40_mode|stored=1|binding=builtin_bmp_info40_mode*}" != "${env_trace}" || {
