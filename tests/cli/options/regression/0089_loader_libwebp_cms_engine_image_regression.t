...
test "${short_trace#*LSXSUB1|*key=cms_engine|stored=1|binding=libwebp_cms_engine*}" != "${short_trace}" || {
...
test "${env_trace#*LSXSUB1|*key=cms_engine|stored=1|binding=libwebp_cms_engine*}" != "${env_trace}" || {
