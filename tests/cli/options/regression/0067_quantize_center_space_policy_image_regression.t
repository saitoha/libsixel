...
test "${short_trace#*LSXSUB1|*key=space_policy|stored=1|binding=quantize_model_kcenter_space_policy,quantize_model_kcenter_space_policy_override*}" != "${short_trace}" || {
...
test "${env_trace#*LSXSUB1|*key=space_policy|stored=1|binding=quantize_model_kcenter_space_policy,quantize_model_kcenter_space_policy_override*}" != "${env_trace}" || {
