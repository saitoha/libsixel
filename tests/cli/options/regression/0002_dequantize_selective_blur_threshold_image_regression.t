...
test "${short_trace#*LSXSUB1|*key=threshold|stored=1|binding=selective_blur_threshold*}" != "${short_trace}" || {
...
test "${env_trace#*LSXSUB1|*key=threshold|stored=1|binding=selective_blur_threshold*}" != "${env_trace}" || {
