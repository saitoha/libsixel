...
cli_output="${ARTIFACT_LOCAL_DIR}/6delta-error-cli-$$.six"
env_output="${ARTIFACT_LOCAL_DIR}/6delta-error-env-$$.six"
...
${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" -l disable -Z 32 \
    --env SIXEL_6DELTA_ERROR=skip "${input}" >"${env_output}" || {
