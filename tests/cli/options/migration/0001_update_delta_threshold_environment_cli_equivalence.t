#!/bin/sh
# Preserve SIXEL_UPDATE_DELTA_THRESHOLD equivalence with delta:threshold.
...
cli_output="${ARTIFACT_LOCAL_DIR}/update-delta-threshold-cli-$$.six"
env_output="${ARTIFACT_LOCAL_DIR}/update-delta-threshold-env-$$.six"
...
${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" -l disable \
    --env SIXEL_UPDATE_DELTA_THRESHOLD=32 -Z delta:error=skip "${input}" \
    >"${env_output}" || {
