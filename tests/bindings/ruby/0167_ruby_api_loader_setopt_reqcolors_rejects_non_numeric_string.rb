...
begin
  ...
  begin
    begin
      ...
      puts 'not ok 1 - loader setopt accepted non-numeric reqcolors string'
    rescue TypeError, ArgumentError
      puts 'ok 1 - loader setopt rejects non-numeric reqcolors string'
    end
  ensure
    Libsixel::API.sixel_loader_unref(loader) if loader && loader.to_i != 0
  end
rescue StandardError => e
  puts 'not ok 1 - reqcolors non-numeric string rejection check failed'
