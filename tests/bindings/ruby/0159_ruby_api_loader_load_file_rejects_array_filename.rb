...
begin
  ...
  begin
    begin
      Libsixel::API.sixel_loader_load_file(loader, [], 0)
      puts 'not ok 1 - loader accepted array filename unexpectedly'
    rescue TypeError
      puts 'ok 1 - loader rejects array filename type'
    end
  ensure
    Libsixel::API.sixel_loader_unref(loader) if loader && loader.to_i != 0
  end
rescue StandardError => e
  puts 'not ok 1 - loader array filename rejection check failed'
