...
begin
  ...
  begin
    begin
      Libsixel::API.sixel_loader_load_file(loader, 123, 0)
      puts 'not ok 1 - loader accepted non-string filename type'
    rescue TypeError, ArgumentError
      puts 'ok 1 - loader load_file rejects non-string filename type'
    end
  ensure
    Libsixel::API.sixel_loader_unref(loader) if loader && loader.to_i != 0
  end
rescue StandardError => e
  puts 'not ok 1 - loader non-string filename rejection check failed'
