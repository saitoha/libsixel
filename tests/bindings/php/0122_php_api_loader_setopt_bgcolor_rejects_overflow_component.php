...
CDEF, $libPath);
    ...
    $rejected = false;
    try {
        $status = (int)$ffi->sixel_loader_setopt($loader, 4, $invalid);
    ...
    if ($rejected) {
        echo "ok 1 - loader setopt bgcolor rejects non-integer components\n";
    } else {
        echo "not ok 1 - loader setopt bgcolor accepted non-integer components\n";
    }
} catch (Throwable $e) {
    echo "not ok 1 - loader bgcolor non-integer component rejection check failed\n";
