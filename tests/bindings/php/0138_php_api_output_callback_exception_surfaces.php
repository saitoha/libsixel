...
try {
    ...
    if ($rc !== 0) {
        echo "ok 1 - output callback exception surfaces as child-process failure\n";
    } else {
        echo "not ok 1 - output callback exception did not surface\n";
    }
} catch (Throwable $e) {
    echo "not ok 1 - output callback exception propagation check failed\n";
