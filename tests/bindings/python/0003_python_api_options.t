...
palette|palette/diffusion/quality options honor palette limit
resize_fixed|explicit resize dimensions survive decode
resize_aspect|width-only resize keeps aspect ratio
CASES
