#!/usr/bin/env python3
"""TAP test for output setter APIs in libsixel.__init__.py."""
...
def test_0038_python_api_output_setters() -> None:
    ...
    sixel_output_set_8bit_availability(output)
    sixel_output_set_gri_arg_limit(output)
    sixel_output_set_penetrate_multiplexer(output)
    sixel_output_set_skip_dcs_envelope(output)
    ...
    sixel_output_set_encode_policy(output)
