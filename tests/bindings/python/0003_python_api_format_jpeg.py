...
def test_0003_python_api_format_jpeg() -> None:
    ...
    try:
        ...
        source = pathlib.Path(os.path.expandvars("${TOP_SRCDIR}/tests/data/inputs/snake_64.jpg"))
        target = pathlib.Path(os.path.expandvars("${ARTIFACT_LOCAL_DIR}/JPEG.six"))
...
if __name__ == "__main__":
    raise SystemExit(run_embedded_tap_test(DESCRIPTION, test_0003_python_api_format_jpeg))
