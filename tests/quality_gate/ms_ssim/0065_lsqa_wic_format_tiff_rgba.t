...
lsqa_floor=${LSQA_MS_SSIM_FLOOR_WIC_TIFF_RGBA:-0.99}
...
run_img2sixel -Lwic! "${image_path}" >"${output_sixel}" || {
    fail 1 "wic tiff rgba conversion failed"
    exit 0
}
...
test "${lsqa_run_status:-0}" -eq 0 && {
    pass 1 "wic tiff rgba quality meets baseline"
    exit 0
}
...
fail 1 "wic tiff rgba quality regressed"
