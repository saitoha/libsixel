#!/bin/sh
# Verify WIC TIFF RGB decoding quality with an MS-SSIM baseline.
...
lsqa_floor=${LSQA_MS_SSIM_FLOOR_WIC_TIFF_RGB:-0.99}
...
output_sixel="${ARTIFACT_LOCAL_DIR}/wic_tiff_rgb.six"
run_img2sixel -Lwic! "${image_path}" >"${output_sixel}" || {
    fail 1 "wic tiff rgb conversion failed"
    exit 0
}
...
test "${lsqa_run_status:-0}" -eq 0 && {
    pass 1 "wic tiff rgb quality meets baseline"
    exit 0
}
...
fail 1 "wic tiff rgb quality regressed"
