...
lsqa_floor=${LSQA_MS_SSIM_FLOOR_WIC_JPEG_GRAYSCALE:-0.96}
...
run_img2sixel -Lwic! "${image_path}" >"${output_sixel}" || {
    fail 1 "wic jpeg grayscale conversion failed"
    exit 0
}
...
test "${lsqa_run_status:-0}" -eq 0 && {
    pass 1 "wic jpeg grayscale quality meets baseline"
    exit 0
}
...
fail 1 "wic jpeg grayscale quality regressed"
