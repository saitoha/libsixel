#!/bin/sh
# Verify WIC PNG palette decoding quality with an MS-SSIM baseline.
...
lsqa_floor=${LSQA_MS_SSIM_FLOOR_WIC_PNG_PALETTE:-0.99}
...
output_sixel="${ARTIFACT_LOCAL_DIR}/wic_png_palette.six"
run_img2sixel -Lwic! "${image_path}" >"${output_sixel}" || {
    fail 1 "wic png palette conversion failed"
    exit 0
}
...
test "${lsqa_run_status:-0}" -eq 0 && {
    pass 1 "wic png palette quality meets baseline"
    exit 0
}
...
fail 1 "wic png palette quality regressed"
