#!/bin/sh
# TAP wrapper for gd pixelformat case: indexed keycolor reqcolors mask.
...
${SIXEL_RUNTIME-} "${TEST_RUNNER_PATH}" \
    ...
    echo "not ok 1 - gd indexed_keycolor_reqcolors_mask"
    exit 0
}

echo "ok 1 - gd indexed_keycolor_reqcolors_mask"
exit 0
