/*
 * Shared GIF logical-screen background fill test implementation.
 */
...
int
loader_gif_bgcolor_canvas_fill_run(
    unsigned char const bgcolor[3],
    unsigned char const expected[12])
{
    return run_case("gif bgcolor canvas fill", bgcolor, expected) == 0;
}
