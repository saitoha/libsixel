#!/bin/sh
# TAP test: libtiff colormgmt parity for lab/img_tiff_lab_icc0_wp0_pc0_trc1.tiff with cms=0
...
output_six="${ARTIFACT_LOCAL_DIR}/img_tiff_lab_icc0_wp0_pc0_trc1_libtiff_cms0.six"
...
echo "ok" 1 - "libtiff colormgmt matches reference with cms=0: lab/img_tiff_lab_icc0_wp0_pc0_trc1"
exit 0
