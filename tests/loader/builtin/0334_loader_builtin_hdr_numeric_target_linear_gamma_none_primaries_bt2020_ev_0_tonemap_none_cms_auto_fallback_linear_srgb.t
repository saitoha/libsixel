...
SIXEL_HDR_CASE_ID='034'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=034 target=linear gamma=none primaries=bt2020 ev=0 tonemap=none cms=auto fallback=linear-srgb'
