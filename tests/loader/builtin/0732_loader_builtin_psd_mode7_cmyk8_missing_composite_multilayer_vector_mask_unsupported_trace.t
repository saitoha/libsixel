#!/bin/sh
# Verify mode7(4ch->CMYK8) vector-mask payload in multi-layer fallback is
...
case "${trace_output}" in
    *"builtin PSD: unsupported vector mask in layer fallback"*)
        echo "ok" 1 - "mode7 CMYK8 vector mask payload is rejected as unsupported"
        ;;
    *)
        echo "not ok" 1 - "mode7 CMYK8 vector mask unsupported trace is missing"
        ;;
esac
