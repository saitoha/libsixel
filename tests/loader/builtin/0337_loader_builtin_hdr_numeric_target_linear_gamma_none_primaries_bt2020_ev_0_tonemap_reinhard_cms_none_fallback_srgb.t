...
SIXEL_HDR_CASE_ID='037'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=037 target=linear gamma=none primaries=bt2020 ev=0 tonemap=reinhard cms=none fallback=srgb'
