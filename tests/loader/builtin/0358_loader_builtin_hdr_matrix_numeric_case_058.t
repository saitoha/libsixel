...
SIXEL_HDR_CASE_ID='058'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=058 target=linear gamma=2.2 primaries=none ev=0 tonemap=none cms=auto fallback=linear-srgb'
