...
SIXEL_HDR_CASE_ID='178'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=178 target=gamma gamma=2.2 primaries=bt2020 ev=0 tonemap=none cms=auto fallback=linear-srgb'
