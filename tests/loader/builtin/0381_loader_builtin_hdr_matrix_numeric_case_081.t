...
SIXEL_HDR_CASE_ID='081'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=081 target=linear gamma=2.2 primaries=bt2020 ev=0 tonemap=none cms=none fallback=srgb'
