...
SIXEL_HDR_CASE_ID='027'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=027 target=linear gamma=none primaries=bt2020 ev=-2 tonemap=none cms=auto fallback=srgb'
