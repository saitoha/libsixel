...
SIXEL_HDR_CASE_ID='100'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=100 target=gamma gamma=none primaries=none ev=-2 tonemap=reinhard cms=none fallback=linear-srgb'
