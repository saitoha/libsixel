...
case "${diag_line}" in
    *FX_GRFL_PARSE*) ;;
    *)
        echo "not ok" 1 - "effects/stroke-composite lost active lfx2 GrFl parse"
        exit 0
        ;;
esac

case "${diag_line}" in
    *FX_GRFL_INACTIVE_PARSE*)
        echo "not ok" 1 - "effects/stroke-composite regressed GrFl into inactive"
        exit 0
        ;;
    *) ;;
esac

echo "ok" 1 - "effects/stroke-composite keeps active lfx2 channels"
exit 0
