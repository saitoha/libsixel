#!/bin/sh
# Verify builtin PSD Gray/Duotone 16-bit alpha compositing responds to --bgcolor.
...
test_no=1
for case_entry in \
    "stbi_minimal_gray16_alpha.psd:grayscale 16-bit+alpha" \
    "stbi_minimal_duotone16_alpha.psd:duotone 16-bit+alpha"
do
