...
input_psd="${TOP_SRCDIR}/tests/data/psd-tools/psdtools_layers_minimal_pattern_fill.psd"
expected_ppm="${TOP_SRCDIR}/tests/data/loader/builtin_expected/psdtools_layers_minimal_pattern_fill_expected_psdtools.ppm"
...
trace_output=$(set +xv; ${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" \
    --lookup-policy=none -Lbuiltin:Eauto! -o "${output_sixel}" \
...
echo "ok" 1 - "layers-minimal/pattern-fill decode keeps MS-SSIM ${lsqa_floor}"
exit 0
