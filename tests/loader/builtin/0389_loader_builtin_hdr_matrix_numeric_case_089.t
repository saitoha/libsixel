...
SIXEL_HDR_CASE_ID='089'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=089 target=linear gamma=2.2 primaries=bt2020 ev=2 tonemap=none cms=none fallback=srgb'
