/* Verify old Radiance scanline RLE after a modern scanline. */
    ...
    char **argv)
{
    ...
    unsigned char const payload[20] = {
        2u, 2u, 0u, 8u,
        136u, 64u, 136u, 32u, 136u, 16u, 136u, 129u,
        64u, 32u, 16u, 129u, 1u, 1u, 1u, 7u
    };
    ...
    if (writer.failed != 0 ||
        edge_load_buffer("HDR old scanline RLE",
                         buffer,
                         writer.length,
                         1,
                         &probe,
    ...
    for (index = 0u; index < 16u; ++index) {
        if (samples[index * 3u] != 0.5f ||
            ...
            fprintf(stderr, "HDR old scanline sample mismatch\n");
            return 1;
        }
    }
    return 0;
