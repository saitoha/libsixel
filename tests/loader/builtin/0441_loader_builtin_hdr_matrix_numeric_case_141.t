...
SIXEL_HDR_CASE_ID='141'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=141 target=gamma gamma=none primaries=bt2020 ev=2 tonemap=reinhard cms=none fallback=srgb'
