#!/bin/sh
# Verify PSB CMYK8 TySh FillOpacity=0.50 keeps malformed ICC skip trace.
...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_psb_cmyk8_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_fillopacity_050_malformed_resource.psd"
trace_log=''
command_status=0
...
echo "ok" 1 - "PSB CMYK8 TySh FillOpacity=0.50 malformed ICC preserves skip trace"
exit 0
