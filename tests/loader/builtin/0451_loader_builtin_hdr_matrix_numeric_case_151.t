...
SIXEL_HDR_CASE_ID='151'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=151 target=gamma gamma=2.2 primaries=none ev=-2 tonemap=reinhard cms=auto fallback=srgb'
