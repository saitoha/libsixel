...
SIXEL_HDR_CASE_ID='012'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=012 target=linear gamma=none primaries=none ev=0 tonemap=reinhard cms=none fallback=linear-srgb'
