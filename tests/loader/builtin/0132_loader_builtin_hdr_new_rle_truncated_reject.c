/* Verify Radiance component RLE rejects a truncated component stream. */
    ...
    char **argv)
{
    ...
    unsigned char const payload[6] = {
        2u, 2u, 0u, 8u, 136u, 64u
    };
    ...
    result = edge_load_buffer("HDR truncated component RLE",
                              buffer,
                              writer.length,
                              1,
                              &probe,
