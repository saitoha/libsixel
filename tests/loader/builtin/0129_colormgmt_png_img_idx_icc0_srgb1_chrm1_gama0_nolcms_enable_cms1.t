#!/bin/sh
# TAP test: builtin loader colormgmt parity (nolcms, enable_cms=1) for idx/img_idx_icc0_srgb1_chrm1_gama0.png
...
output_six="${ARTIFACT_LOCAL_DIR}/img_idx_icc0_srgb1_chrm1_gama0_builtin_nolcms_enable_cms1.six"
...
echo "ok" 1 - "builtin colormgmt (nolcms, enable_cms=1) matches reference: idx/img_idx_icc0_srgb1_chrm1_gama0.png"
exit 0
