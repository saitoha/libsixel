...
SIXEL_HDR_CASE_ID='018'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=018 target=linear gamma=none primaries=none ev=2 tonemap=none cms=auto fallback=linear-srgb'
