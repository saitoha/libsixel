...
SIXEL_HDR_CASE_ID='072'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=072 target=linear gamma=2.2 primaries=bt2020 ev=-2 tonemap=none cms=none fallback=linear-srgb'
