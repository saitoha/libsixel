...
SIXEL_HDR_CASE_ID='159'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=159 target=gamma gamma=2.2 primaries=none ev=0 tonemap=reinhard cms=auto fallback=srgb'
