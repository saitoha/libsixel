...
test "${diag_line#*W_UNSUP_ANIM*}" != "${diag_line}" || {
    echo "not ok" 1 - "forced builtin loader corrupted fixture bad_vp8x_anim_flag_without_anmf_chunk.webp missing W_UNSUP_ANIM contract code"
    exit 0
}

echo "ok" 1 - "forced builtin loader corrupted fixture bad_vp8x_anim_flag_without_anmf_chunk.webp emits W_UNSUP_ANIM contract code"
exit 0
