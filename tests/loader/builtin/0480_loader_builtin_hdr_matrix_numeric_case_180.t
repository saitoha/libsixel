...
SIXEL_HDR_CASE_ID='180'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=180 target=gamma gamma=2.2 primaries=bt2020 ev=0 tonemap=reinhard cms=none fallback=linear-srgb'
