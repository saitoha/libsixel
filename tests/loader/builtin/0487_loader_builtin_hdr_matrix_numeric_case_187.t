...
SIXEL_HDR_CASE_ID='187'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=187 target=gamma gamma=2.2 primaries=bt2020 ev=2 tonemap=none cms=auto fallback=srgb'
