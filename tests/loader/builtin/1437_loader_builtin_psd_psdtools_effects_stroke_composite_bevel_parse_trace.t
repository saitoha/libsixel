#!/bin/sh
# Verify bevel parse code contract remains visible on effects/stroke-composite.
...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - "effects/stroke-composite did not parse bevel highlight"
        exit 0
        ;;
esac
...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - "effects/stroke-composite did not parse ebbl bevel"
        exit 0
        ;;
esac

echo "ok" 1 - "effects/stroke-composite keeps bevel parse trace contract"
exit 0
