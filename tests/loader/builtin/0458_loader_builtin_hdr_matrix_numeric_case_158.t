...
SIXEL_HDR_CASE_ID='158'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=158 target=gamma gamma=2.2 primaries=none ev=0 tonemap=reinhard cms=auto fallback=linear-srgb'
