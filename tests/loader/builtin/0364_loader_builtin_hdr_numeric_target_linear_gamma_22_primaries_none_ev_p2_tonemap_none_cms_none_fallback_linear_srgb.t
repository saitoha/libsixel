...
SIXEL_HDR_CASE_ID='064'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=064 target=linear gamma=2.2 primaries=none ev=2 tonemap=none cms=none fallback=linear-srgb'
