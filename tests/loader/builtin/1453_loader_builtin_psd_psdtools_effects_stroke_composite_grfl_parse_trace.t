#!/bin/sh
# Verify GrFl effect payload is parsed as active for
...
case "${diag_line}" in
    *FX_GRFL_PARSE*) ;;
    *)
        echo "not ok" 1 - "effects/stroke-composite did not parse active GrFl"
        exit 0
        ;;
esac
...
echo "ok" 1 - "effects/stroke-composite parses active GrFl payload"
exit 0
