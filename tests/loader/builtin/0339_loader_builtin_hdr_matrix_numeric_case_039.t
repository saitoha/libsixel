...
SIXEL_HDR_CASE_ID='039'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=039 target=linear gamma=none primaries=bt2020 ev=0 tonemap=reinhard cms=auto fallback=srgb'
