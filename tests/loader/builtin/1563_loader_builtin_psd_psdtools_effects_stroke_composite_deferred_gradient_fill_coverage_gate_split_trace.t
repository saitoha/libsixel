#!/bin/sh
# Verify deferred gradient coverage split diagnostics are preserved.
...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - \
            "effects/stroke-composite missing deferred gradient split"
        exit 0
        ;;
esac

echo "ok" 1 - "effects/stroke-composite keeps deferred gradient split"
exit 0
