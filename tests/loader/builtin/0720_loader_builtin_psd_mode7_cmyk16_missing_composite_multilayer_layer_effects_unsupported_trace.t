#!/bin/sh
# Verify mode7(4ch->CMYK16) layer-effects payload in multi-layer fallback is
...
case "${trace_output}" in
    *"builtin PSD: unsupported layer effects in layer fallback"*)
        echo "ok" 1 - "mode7 CMYK16 layer effects payload is rejected as unsupported"
        ;;
    *)
        echo "not ok" 1 - "mode7 CMYK16 layer effects unsupported trace is missing"
        ;;
esac
