...
SIXEL_HDR_CASE_ID='165'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=165 target=gamma gamma=2.2 primaries=none ev=2 tonemap=reinhard cms=none fallback=srgb'
