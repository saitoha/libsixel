#!/bin/sh
# Verify clbl=1 deferred overlay suppression keeps tail ordering consistent.
...
echo "ok" 1 - "effects/stroke-composite keeps suppression tail consistent with deferred gradient overlay"
exit 0
