#!/bin/sh
# TAP test confirming hidden VP8 frame maps to malformed stream error.
...
test "${diag_line#*W_ERR_VP8_STREAM*}" != "${diag_line}" || {
    echo "not ok" 1 - "forced builtin loader corrupted VP8 hidden frame fixture missing W_ERR_VP8_STREAM contract code"
    exit 0
}

echo "ok" 1 - "forced builtin loader corrupted VP8 hidden frame fixture emits W_ERR_VP8_STREAM contract code"
exit 0
