...
SIXEL_HDR_CASE_ID='061'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=061 target=linear gamma=2.2 primaries=none ev=0 tonemap=reinhard cms=none fallback=srgb'
