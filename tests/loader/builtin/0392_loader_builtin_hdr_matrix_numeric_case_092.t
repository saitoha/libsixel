...
SIXEL_HDR_CASE_ID='092'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=092 target=linear gamma=2.2 primaries=bt2020 ev=2 tonemap=reinhard cms=none fallback=linear-srgb'
