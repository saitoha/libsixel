...
SIXEL_HDR_CASE_ID='043'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=043 target=linear gamma=none primaries=bt2020 ev=2 tonemap=none cms=auto fallback=srgb'
