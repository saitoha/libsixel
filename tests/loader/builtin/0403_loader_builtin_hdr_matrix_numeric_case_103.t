...
SIXEL_HDR_CASE_ID='103'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=103 target=gamma gamma=none primaries=none ev=-2 tonemap=reinhard cms=auto fallback=srgb'
