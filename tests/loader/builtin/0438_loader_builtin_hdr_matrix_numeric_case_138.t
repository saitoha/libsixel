...
SIXEL_HDR_CASE_ID='138'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=138 target=gamma gamma=none primaries=bt2020 ev=2 tonemap=none cms=auto fallback=linear-srgb'
