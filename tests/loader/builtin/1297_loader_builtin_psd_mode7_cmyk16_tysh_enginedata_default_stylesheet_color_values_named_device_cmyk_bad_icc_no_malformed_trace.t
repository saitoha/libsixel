...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_mode7_cmyk16_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_default_stylesheet_color_values_named_device_cmyk_bad_icc_profile.psd"
trace_log=''
command_status=0
...
case "${trace_log}" in
    *"malformed ICC resource section; skipping ICC conversion"*)
        echo "not ok" 1 - "bad ICC was misclassified as malformed ICC resource"
        exit 0
        ;;
esac

echo "ok" 1 - "PSD mode7 CMYK16 TySh /DefaultStyleSheet /Color DeviceCMYK bad ICC decodes without malformed-resource misclassification"
exit 0
