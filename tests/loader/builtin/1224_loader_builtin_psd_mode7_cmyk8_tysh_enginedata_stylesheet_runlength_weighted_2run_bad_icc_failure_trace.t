#!/bin/sh
# Verify PSD mode7 TySh weighted run-length fixture keeps bad ICC failure trace.
...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_mode7_cmyk8_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_stylesheet_runlength_weighted_2run_bad_icc_profile.psd"
trace_log=''
command_status=0
...
echo "ok" 1 - "PSD mode7 TySh weighted run-length bad ICC preserves failure trace"
exit 0
