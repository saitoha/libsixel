...
input_psd="${TOP_SRCDIR}/tests/data/psd-tools/psdtools_layer_name_emoji.psd"
expected_ppm="${TOP_SRCDIR}/tests/data/loader/builtin_expected/psdtools_layer_name_emoji_expected_psdtools.ppm"
...
echo "ok" 1 - "layer-name-emoji decode keeps MS-SSIM ${lsqa_floor}"
exit 0
