...
test "${command_status}" -eq 0 || {
    echo "not ok" 1 - "blend-and-clipping decode failed # TODO psd-tools parity gap"
    exit 0
}
...
lsqa_msg=$(set +xv; ${SIXEL_RUNTIME-} "${LSQA_PATH}" -m MS-SSIM -W linear \
    ...
    echo "not ok" 1 - "blend-and-clipping decode fell below MS-SSIM ${lsqa_floor} # TODO psd-tools parity gap"
    exit 0
}
