...
SIXEL_HDR_CASE_ID='015'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=015 target=linear gamma=none primaries=none ev=0 tonemap=reinhard cms=auto fallback=srgb'
