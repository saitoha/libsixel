...
SIXEL_HDR_CASE_ID='030'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=030 target=linear gamma=none primaries=bt2020 ev=-2 tonemap=reinhard cms=auto fallback=linear-srgb'
