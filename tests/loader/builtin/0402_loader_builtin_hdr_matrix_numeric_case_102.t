...
SIXEL_HDR_CASE_ID='102'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=102 target=gamma gamma=none primaries=none ev=-2 tonemap=reinhard cms=auto fallback=linear-srgb'
