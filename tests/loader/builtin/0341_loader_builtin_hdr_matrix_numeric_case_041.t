...
SIXEL_HDR_CASE_ID='041'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=041 target=linear gamma=none primaries=bt2020 ev=2 tonemap=none cms=none fallback=srgb'
