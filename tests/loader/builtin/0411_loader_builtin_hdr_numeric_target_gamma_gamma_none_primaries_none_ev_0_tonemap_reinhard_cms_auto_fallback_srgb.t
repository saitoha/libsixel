...
SIXEL_HDR_CASE_ID='111'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=111 target=gamma gamma=none primaries=none ev=0 tonemap=reinhard cms=auto fallback=srgb'
