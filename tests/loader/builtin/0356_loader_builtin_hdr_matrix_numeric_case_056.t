...
SIXEL_HDR_CASE_ID='056'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=056 target=linear gamma=2.2 primaries=none ev=0 tonemap=none cms=none fallback=linear-srgb'
