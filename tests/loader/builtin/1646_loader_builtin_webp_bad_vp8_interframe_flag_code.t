...
input_webp="${TOP_SRCDIR}/tests/data/corrupted/bad_vp8_interframe_flag.webp"
trace_output=''
diag_line=''
command_status=0
nl='
...
test "${command_status}" -ne 0 || {
    echo "not ok" 1 - "forced builtin loader corrupted VP8 interframe fixture unexpectedly succeeded"
    exit 0
}
