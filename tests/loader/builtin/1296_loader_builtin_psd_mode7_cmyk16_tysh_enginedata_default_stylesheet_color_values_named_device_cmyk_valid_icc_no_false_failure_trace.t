...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_mode7_cmyk16_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_default_stylesheet_color_values_named_device_cmyk_valid_icc_profile.psd"
trace_log=''
command_status=0
...
echo "ok" 1 - "PSD mode7 CMYK16 TySh /DefaultStyleSheet /Color DeviceCMYK valid ICC avoids false failure trace"
exit 0
