#!/bin/sh
# Verify wrapper-path deferred replay keeps post-commit block code disabled.
...
echo "ok" 1 - \
    "effects/stroke-composite keeps wrapper-path deferred replay post-commit clean"
exit 0
