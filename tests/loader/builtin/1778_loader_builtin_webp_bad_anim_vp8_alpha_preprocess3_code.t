#!/bin/sh
# TAP test confirming unsupported VP8+ALPH preprocess=3 in ANMF stays UNSUP.
...
test "${diag_line#*W_UNSUP_VP8_ALPHA*}" != "${diag_line}" || {
    echo "not ok" 1 - "forced builtin loader bad_anim_vp8_alpha_preprocess3.webp missing W_UNSUP_VP8_ALPHA"
    exit 0
}

echo "ok" 1 - "forced builtin loader bad_anim_vp8_alpha_preprocess3.webp emits W_UNSUP_VP8_ALPHA"
exit 0
