...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_cmyk32_missing_composite_marker.psd"
...
case "${trace_log}" in
    *"builtin PSD: unsupported layer fallback layout"*)
        echo "ok" 1 - "CMYK32 missing-composite marker is rejected as unsupported layout"
        ;;
    *)
        echo "not ok" 1 - "CMYK32 missing-composite unsupported-layout trace is missing"
        exit 0
        ;;
esac
