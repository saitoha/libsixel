...
case "${diag_line}" in
    *FX_DEFERRED_BEVEL_LIGHT_SEM*)
        echo "not ok" 1 - "effects/stroke-composite unexpectedly emitted FX_DEFERRED_BEVEL_LIGHT_SEM"
        exit 0
        ;;
esac
...
echo "ok" 1 - \
    "effects/stroke-composite keeps deferred gradient/stroke diagnostic contract"
exit 0
