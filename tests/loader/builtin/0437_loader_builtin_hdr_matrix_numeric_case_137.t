...
SIXEL_HDR_CASE_ID='137'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=137 target=gamma gamma=none primaries=bt2020 ev=2 tonemap=none cms=none fallback=srgb'
