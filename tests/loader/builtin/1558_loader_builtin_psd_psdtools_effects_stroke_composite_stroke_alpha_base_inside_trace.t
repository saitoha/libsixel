#!/bin/sh
# Verify inside fixture keeps base inside stroke-alpha write semantics.
...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - \
            "effects/stroke-composite missing base inside alpha-write"
        exit 0
        ;;
esac

echo "ok" 1 - "effects/stroke-composite keeps base inside alpha-write"
exit 0
