...
SIXEL_HDR_CASE_ID='045'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=045 target=linear gamma=none primaries=bt2020 ev=2 tonemap=reinhard cms=none fallback=srgb'
