#!/bin/sh
# Verify builtin PSD decode reaches psd-tools baseline for effects/shape-fx2.psd.
...
expected_ppm="${TOP_SRCDIR}/tests/data/loader/builtin_expected/psdtools_effects_shape_fx2_expected_psdtools.ppm"
...
lsqa_msg=$(set +xv; ${SIXEL_RUNTIME-} "${LSQA_PATH}" -m MS-SSIM -W linear \
    ...
    echo "not ok" 1 - "effects/shape-fx2 decode fell below MS-SSIM ${lsqa_floor}"
    exit 0
}

: "${lsqa_msg}"

echo "ok" 1 - "effects/shape-fx2 decode keeps MS-SSIM ${lsqa_floor}"
exit 0
