...
SIXEL_HDR_CASE_ID='143'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=143 target=gamma gamma=none primaries=bt2020 ev=2 tonemap=reinhard cms=auto fallback=srgb'
