...
SIXEL_HDR_CASE_ID='040'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=040 target=linear gamma=none primaries=bt2020 ev=2 tonemap=none cms=none fallback=linear-srgb'
