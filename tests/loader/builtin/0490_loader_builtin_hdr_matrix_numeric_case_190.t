...
SIXEL_HDR_CASE_ID='190'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=190 target=gamma gamma=2.2 primaries=bt2020 ev=2 tonemap=reinhard cms=auto fallback=linear-srgb'
