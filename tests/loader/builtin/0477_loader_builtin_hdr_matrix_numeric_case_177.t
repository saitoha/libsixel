...
SIXEL_HDR_CASE_ID='177'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=177 target=gamma gamma=2.2 primaries=bt2020 ev=0 tonemap=none cms=none fallback=srgb'
