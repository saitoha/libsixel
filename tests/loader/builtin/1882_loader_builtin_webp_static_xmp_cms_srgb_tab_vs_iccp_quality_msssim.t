#!/bin/sh
# TAP test comparing static tab-separated sRGB XMP CMS output against ICCP output.
# Pair: orientation_xmp_icc_srgb_tab_vp8_static_12x8.webp vs
...
input_xmp="${TOP_SRCDIR}/tests/data/inputs/formats/orientation_xmp_icc_srgb_tab_vp8_static_12x8.webp"
...
${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" -S -L builtin! \
    ...
    echo "not ok" 1 - "builtin static tab-separated sRGB XMP CMS quality decode failed"
    exit 0
}
...
echo "ok" 1 - "builtin static tab-separated sRGB XMP CMS quality keeps MS-SSIM >= 0.98"
exit 0
