...
SIXEL_HDR_CASE_ID='078'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=078 target=linear gamma=2.2 primaries=bt2020 ev=-2 tonemap=reinhard cms=auto fallback=linear-srgb'
