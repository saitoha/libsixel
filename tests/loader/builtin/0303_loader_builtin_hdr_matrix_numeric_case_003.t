...
SIXEL_HDR_CASE_ID='003'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=003 target=linear gamma=none primaries=none ev=-2 tonemap=none cms=auto fallback=srgb'
