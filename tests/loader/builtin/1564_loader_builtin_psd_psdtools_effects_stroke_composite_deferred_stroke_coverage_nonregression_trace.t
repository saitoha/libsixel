#!/bin/sh
# Verify deferred stroke coverage split diagnostics are preserved.
...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - \
            "effects/stroke-composite lost deferred stroke coverage split"
        exit 0
        ;;
esac

echo "ok" 1 - "effects/stroke-composite keeps deferred stroke split"
exit 0
