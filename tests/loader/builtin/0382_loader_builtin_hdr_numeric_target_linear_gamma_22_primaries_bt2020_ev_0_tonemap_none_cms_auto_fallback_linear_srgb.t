...
SIXEL_HDR_CASE_ID='082'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=082 target=linear gamma=2.2 primaries=bt2020 ev=0 tonemap=none cms=auto fallback=linear-srgb'
