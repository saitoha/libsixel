...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_cmyk8_zip_pred.psd"
...
echo "ok" 1 - "builtin CMYK 8-bit ZIP+prediction keeps MS-SSIM ${lsqa_floor} against expected PPM"
exit 0
