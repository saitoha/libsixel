...
SIXEL_HDR_CASE_ID='108'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=108 target=gamma gamma=none primaries=none ev=0 tonemap=reinhard cms=none fallback=linear-srgb'
