...
SIXEL_HDR_CASE_ID='184'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=184 target=gamma gamma=2.2 primaries=bt2020 ev=2 tonemap=none cms=none fallback=linear-srgb'
