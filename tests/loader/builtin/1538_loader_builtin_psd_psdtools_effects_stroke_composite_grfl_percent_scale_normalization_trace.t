...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - "effects/stroke-composite missing FX_GRFL_SCALE_NORMALIZE"
        exit 0
        ;;
esac

echo "ok" 1 - "effects/stroke-composite keeps GrFl percent normalization code contract"
exit 0
