#!/bin/sh
# Verify PSD CMYK8 TySh /DefaultStyleSheet valid ICC avoids false failure trace.
...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_cmyk8_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_default_stylesheet_values_rgb_valid_icc_profile.psd"
trace_log=''
command_status=0
...
echo "ok" 1 - "PSD CMYK8 TySh /DefaultStyleSheet valid ICC avoids false failure trace"
exit 0
