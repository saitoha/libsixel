...
SIXEL_HDR_CASE_ID='114'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=114 target=gamma gamma=none primaries=none ev=2 tonemap=none cms=auto fallback=linear-srgb'
