...
SIXEL_HDR_CASE_ID='095'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=095 target=linear gamma=2.2 primaries=bt2020 ev=2 tonemap=reinhard cms=auto fallback=srgb'
