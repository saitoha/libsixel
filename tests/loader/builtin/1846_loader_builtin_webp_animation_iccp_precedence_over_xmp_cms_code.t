#!/bin/sh
# TAP test confirming animated WebP keeps ICCP precedence over XMP CMS.
...
input_webp="${TOP_SRCDIR}/tests/data/inputs/formats/animated-lossy-8x8-2frame-min-embedded-srgb-icc-xmp-icc-displayp3.webp"
trace_output=''
diag_line=''
command_status=0
nl='
