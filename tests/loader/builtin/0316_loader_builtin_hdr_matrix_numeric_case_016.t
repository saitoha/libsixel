...
SIXEL_HDR_CASE_ID='016'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=016 target=linear gamma=none primaries=none ev=2 tonemap=none cms=none fallback=linear-srgb'
