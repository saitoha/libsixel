...
input_xmp="${TOP_SRCDIR}/tests/data/inputs/formats/animated-lossy-8x8-2frame-min-xmp-icc-srgb.webp"
...
${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" -S -L builtin! -ldisable \
    ...
    echo "not ok" 1 - "builtin animated XMP CMS quality decode failed"
    exit 0
}
...
echo "ok" 1 - "builtin animated XMP CMS quality keeps MS-SSIM >= 0.98"
exit 0
