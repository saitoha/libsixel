...
SIXEL_HDR_CASE_ID='021'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=021 target=linear gamma=none primaries=none ev=2 tonemap=reinhard cms=none fallback=srgb'
