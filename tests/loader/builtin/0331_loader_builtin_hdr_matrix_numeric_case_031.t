...
SIXEL_HDR_CASE_ID='031'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=031 target=linear gamma=none primaries=bt2020 ev=-2 tonemap=reinhard cms=auto fallback=srgb'
