...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_psb_cmyk8_missing_composite_multilayer_channel_length_u64max.psd"
...
case "${trace_log}" in
    *"builtin PSD: malformed PSB layer channel length"*)
        echo "ok" 1 - "PSB mode4 CMYK8 UINT64_MAX channel-length keeps dedicated malformed trace"
        ;;
    *)
        echo "not ok" 1 - "PSB mode4 CMYK8 UINT64_MAX channel-length trace is missing"
        exit 0
        ;;
esac
