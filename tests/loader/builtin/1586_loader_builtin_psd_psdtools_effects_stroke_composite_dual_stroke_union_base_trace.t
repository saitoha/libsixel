#!/bin/sh
# Verify base dual-stroke union diagnostics are preserved.
...
case "${diag_line}" in
    *FX_DUAL_SOURCE_BASE*) ;;
    *)
        echo "not ok" 1 - "effects/stroke-composite lost base dual-source trace"
        exit 0
        ;;
esac
...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - "effects/stroke-composite lost base dual-overlap trace"
        exit 0
        ;;
esac

echo "ok" 1 - "effects/stroke-composite keeps base dual-stroke union trace"
exit 0
