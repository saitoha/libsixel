...
SIXEL_HDR_CASE_ID='140'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=140 target=gamma gamma=none primaries=bt2020 ev=2 tonemap=reinhard cms=none fallback=linear-srgb'
