#!/bin/sh
# Verify PSB TySh weighted run-length fixture keeps malformed ICC skip trace.
...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_psb_cmyk8_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_stylesheet_runlength_weighted_2run_malformed_resource.psd"
trace_log=''
command_status=0
...
echo "ok" 1 - "PSB TySh weighted run-length malformed ICC preserves skip trace"
exit 0
