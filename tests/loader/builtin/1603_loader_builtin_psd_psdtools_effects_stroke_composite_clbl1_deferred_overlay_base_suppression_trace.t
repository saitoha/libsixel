...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - "effects/stroke-composite missing FX_CLBL1_DEFER_INTERIOR code"
        exit 0
        ;;
esac
...
echo "ok" 1 - "effects/stroke-composite keeps clbl=1 deferred overlay routing contract"
exit 0
