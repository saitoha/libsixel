#!/bin/sh
# Verify blend-and-clipping exposes bevel lighting semantics trace.
...
test "${trace_output#*builtin PSD: parsed ebbl bevel object in layer effects \(inactive\)*}" \
    != "${trace_output}" || {
    echo "not ok" 1 - "blend-and-clipping lost bevel inactive parse trace"
    exit 0
}

echo "ok" 1 - "blend-and-clipping keeps bevel lighting semantics trace"
exit 0
