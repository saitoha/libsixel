/* Fix the decoded RGB plane and transparency mask for ALPH filter 2. */

#include "loader_builtin_memory_test_common.h"

int
test_loader_0147_loader_builtin_webp_alph_filter2_numeric(int argc,
                                                           char **argv)
{
    ...
    return edge_expect_fixture_rgb_mask_digests(
        "WebP ALPH filter 2",
        "/tests/data/inputs/formats/webp-vp8-alpha-snake64-filter2.webp",
        &options,
        64,
        64,
        1,
