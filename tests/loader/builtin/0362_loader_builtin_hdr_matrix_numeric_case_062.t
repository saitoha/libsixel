...
SIXEL_HDR_CASE_ID='062'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=062 target=linear gamma=2.2 primaries=none ev=0 tonemap=reinhard cms=auto fallback=linear-srgb'
