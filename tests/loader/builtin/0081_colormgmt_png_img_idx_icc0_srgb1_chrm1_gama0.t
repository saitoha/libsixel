#!/bin/sh
# TAP test: builtin loader colormgmt parity for idx/img_idx_icc0_srgb1_chrm1_gama0.png
...
output_six="${ARTIFACT_LOCAL_DIR}/img_idx_icc0_srgb1_chrm1_gama0_builtin.six"
...
echo "ok" 1 "builtin colormgmt matches reference: idx/img_idx_icc0_srgb1_chrm1_gama0.png"
exit 0
