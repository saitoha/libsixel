#!/bin/sh
# Verify builtin PSD Lab alpha compositing responds to --bgcolor.
...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/stbi_minimal_lab8_alpha.psd"
output_black_six="${ARTIFACT_LOCAL_DIR}/psd_lab_alpha_bg_black.six"
output_white_six="${ARTIFACT_LOCAL_DIR}/psd_lab_alpha_bg_white.six"
output_black_png="${ARTIFACT_LOCAL_DIR}/psd_lab_alpha_bg_black.png"
output_white_png="${ARTIFACT_LOCAL_DIR}/psd_lab_alpha_bg_white.png"
...
test "${lsqa_status}" -eq 5 || {
    echo "not ok" 1 - "PSD bgcolor did not affect Lab alpha output: ${lsqa_msg}"
    exit 0
}

echo "ok" 1 - "builtin PSD Lab alpha compositing changes with bgcolor"
exit 0
