...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - \
            "effects/stroke-composite did not parse IrSh offset semantics"
        exit 0
        ;;
esac
...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - \
            "effects/stroke-composite lost IrSh inactive parse trace"
        exit 0
        ;;
esac
...
echo "ok" 1 - \
    "effects/stroke-composite keeps IrSh shadow-offset inactive contract"
exit 0
