#!/bin/sh
# Verify builtin loader decodes Gray/Indexed 8-bit PSD (raw and RLE).
...
test_no=1
for case_entry in \
    "stbi_minimal_gray8.psd:grayscale 8-bit raw" \
    "stbi_minimal_gray8_rle.psd:grayscale 8-bit RLE" \
    "stbi_minimal_indexed8.psd:indexed 8-bit raw" \
    "stbi_minimal_indexed8_rle.psd:indexed 8-bit RLE"
do
