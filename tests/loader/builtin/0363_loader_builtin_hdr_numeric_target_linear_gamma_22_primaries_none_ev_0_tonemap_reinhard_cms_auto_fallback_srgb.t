...
SIXEL_HDR_CASE_ID='063'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=063 target=linear gamma=2.2 primaries=none ev=0 tonemap=reinhard cms=auto fallback=srgb'
