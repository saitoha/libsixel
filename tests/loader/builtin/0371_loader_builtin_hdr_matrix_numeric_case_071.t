...
SIXEL_HDR_CASE_ID='071'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=071 target=linear gamma=2.2 primaries=none ev=2 tonemap=reinhard cms=auto fallback=srgb'
