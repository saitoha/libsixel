#!/bin/sh
# Verify mode7(4ch->CMYK16) knockout payload in multi-layer fallback is
...
case "${trace_output}" in
    *"builtin PSD: unsupported knockout in layer fallback"*)
        echo "ok" 1 - "mode7 CMYK16 knockout payload is rejected as unsupported"
        ;;
    *)
        echo "not ok" 1 - "mode7 CMYK16 knockout unsupported trace is missing"
        ;;
esac
