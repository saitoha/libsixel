...
SIXEL_HDR_CASE_ID='132'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=132 target=gamma gamma=none primaries=bt2020 ev=0 tonemap=reinhard cms=none fallback=linear-srgb'
