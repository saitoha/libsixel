#!/bin/sh
# Verify blend-and-clipping exposes OrGl source/choke/range semantics trace.
...
test "${trace_output#*builtin PSD: parsed OrGl effect object in layer effects \(inactive\)*}" \
    != "${trace_output}" || {
    echo "not ok" 1 - "blend-and-clipping lost OrGl inactive parse trace"
    exit 0
}

echo "ok" 1 - "blend-and-clipping keeps OrGl source/choke/range semantics trace"
exit 0
