...
SIXEL_HDR_CASE_ID='070'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=070 target=linear gamma=2.2 primaries=none ev=2 tonemap=reinhard cms=auto fallback=linear-srgb'
