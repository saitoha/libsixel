...
SIXEL_HDR_CASE_ID='005'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=005 target=linear gamma=none primaries=none ev=-2 tonemap=reinhard cms=none fallback=srgb'
