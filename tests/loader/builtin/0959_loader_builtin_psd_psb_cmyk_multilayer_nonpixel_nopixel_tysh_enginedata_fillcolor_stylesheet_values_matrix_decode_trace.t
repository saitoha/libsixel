...
for case_name in \
    snake16_psb_cmyk8_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_stylesheet_values_cmyk \
    snake16_psb_cmyk16_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_stylesheet_values_cmyk \
    snake16_psb_cmyk32_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_stylesheet_values_cmyk \
    snake16_psb_mode7_cmyk8_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_stylesheet_values_cmyk \
    snake16_psb_mode7_cmyk16_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_stylesheet_values_cmyk \
    snake16_psb_mode7_cmyk32_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_stylesheet_values_cmyk
 do
    ...
    test "${command_status}" -eq 0 || {
        echo "not ok" 1 - "builtin loader failed to decode PSB TySh EngineData StyleSheetData fixture ${case_name}: ${trace_output}"
        status=1
        break
    }
    ...
    lsqa_msg=$(set +xv; ${SIXEL_RUNTIME-} "${LSQA_PATH}" -m MS-SSIM -W linear \
        ...
        echo "not ok" 1 - "PSB TySh EngineData StyleSheetData CMYK decode fell below MS-SSIM ${lsqa_floor} for ${case_name}: ${lsqa_msg}"
        status=1
        break
    }
 done
...
echo "ok" 1 - "PSB TySh EngineData StyleSheetData matrix keeps deterministic trace and MS-SSIM ${lsqa_floor}"
exit 0
