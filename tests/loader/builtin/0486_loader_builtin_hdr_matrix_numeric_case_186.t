...
SIXEL_HDR_CASE_ID='186'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=186 target=gamma gamma=2.2 primaries=bt2020 ev=2 tonemap=none cms=auto fallback=linear-srgb'
