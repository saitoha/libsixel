...
SIXEL_HDR_CASE_ID='010'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=010 target=linear gamma=none primaries=none ev=0 tonemap=none cms=auto fallback=linear-srgb'
