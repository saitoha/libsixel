...
SIXEL_HDR_CASE_ID='022'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=022 target=linear gamma=none primaries=none ev=2 tonemap=reinhard cms=auto fallback=linear-srgb'
