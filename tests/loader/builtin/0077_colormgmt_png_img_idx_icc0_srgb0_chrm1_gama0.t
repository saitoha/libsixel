#!/bin/sh
# TAP test: builtin loader colormgmt parity for idx/img_idx_icc0_srgb0_chrm1_gama0.png
...
echo "ok" 1 "builtin colormgmt matches reference: idx/img_idx_icc0_srgb0_chrm1_gama0.png"
exit 0
