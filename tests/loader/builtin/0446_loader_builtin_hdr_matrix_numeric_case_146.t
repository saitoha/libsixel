...
SIXEL_HDR_CASE_ID='146'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=146 target=gamma gamma=2.2 primaries=none ev=-2 tonemap=none cms=auto fallback=linear-srgb'
