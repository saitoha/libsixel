#!/bin/sh
# Verify PSD mode7 CMYK8 TySh /DefaultStyleSheet bad ICC emits failure trace.
...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_mode7_cmyk8_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_default_stylesheet_values_rgb_bad_icc_profile.psd"
trace_log=''
command_status=0
...
echo "ok" 1 - "PSD mode7 CMYK8 TySh /DefaultStyleSheet bad ICC keeps failure trace"
exit 0
