...
SIXEL_HDR_CASE_ID='128'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=128 target=gamma gamma=none primaries=bt2020 ev=0 tonemap=none cms=none fallback=linear-srgb'
