...
#   magick tests/data/inputs/formats/stbi_minimal_gray32_raw.psd \
#       -depth 8 -define ppm:format=raw \
#       PPM:tests/data/loader/builtin_expected/psd_gray32_raw_expected.ppm
...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/stbi_minimal_gray32_zip_pred.psd"
