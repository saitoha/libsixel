...
test "${diag_line#*W_UNSUP_VP8_STATIC*}" != "${diag_line}" || {
    echo "not ok" 1 - "forced builtin loader rejects lossy VP8 ICCP WebP missing W_UNSUP_VP8_STATIC contract code"
    exit 0
}

echo "ok" 1 - "forced builtin loader rejects lossy VP8 ICCP WebP emits W_UNSUP_VP8_STATIC contract code"
exit 0
