...
SIXEL_HDR_CASE_ID='085'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=085 target=linear gamma=2.2 primaries=bt2020 ev=0 tonemap=reinhard cms=none fallback=srgb'
