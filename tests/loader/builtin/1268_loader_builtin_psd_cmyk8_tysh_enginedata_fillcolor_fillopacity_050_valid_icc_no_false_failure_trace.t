#!/bin/sh
# Verify PSD CMYK8 TySh FillOpacity=0.50 avoids false failure trace on valid ICC.
...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_cmyk8_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_fillopacity_050_valid_icc_profile.psd"
trace_log=''
command_status=0
...
echo "ok" 1 - "PSD CMYK8 TySh FillOpacity=0.50 valid ICC avoids false failure trace"
exit 0
