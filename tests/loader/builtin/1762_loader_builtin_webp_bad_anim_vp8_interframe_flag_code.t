#!/bin/sh
# TAP test confirming unsupported VP8 interframe inside ANMF stays UNSUP.
...
input_webp="${TOP_SRCDIR}/tests/data/corrupted/bad_anim_vp8_interframe_flag.webp"
trace_output=''
diag_line=''
command_status=0
nl='
...
test "${diag_line#*W_UNSUP_VP8_FEATURE*}" != "${diag_line}" || {
    echo "not ok" 1 - "forced builtin loader bad_anim_vp8_interframe_flag.webp missing W_UNSUP_VP8_FEATURE"
    exit 0
}

echo "ok" 1 - "forced builtin loader bad_anim_vp8_interframe_flag.webp emits W_UNSUP_VP8_FEATURE"
exit 0
