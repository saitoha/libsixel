...
SIXEL_HDR_CASE_ID='000'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=000 target=linear gamma=none primaries=none ev=-2 tonemap=none cms=none fallback=linear-srgb'
