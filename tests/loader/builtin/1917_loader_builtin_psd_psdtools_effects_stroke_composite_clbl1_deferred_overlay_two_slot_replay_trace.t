#!/bin/sh
# Verify clbl=1 deferred overlay replay keeps GrFl active with slot capture.
...
echo "ok" 1 - "effects/stroke-composite keeps deferred gradient replay after clbl=1 suppression"
exit 0
