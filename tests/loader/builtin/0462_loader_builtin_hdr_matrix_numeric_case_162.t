...
SIXEL_HDR_CASE_ID='162'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=162 target=gamma gamma=2.2 primaries=none ev=2 tonemap=none cms=auto fallback=linear-srgb'
