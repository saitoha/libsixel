...
SIXEL_HDR_CASE_ID='135'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=135 target=gamma gamma=none primaries=bt2020 ev=0 tonemap=reinhard cms=auto fallback=srgb'
