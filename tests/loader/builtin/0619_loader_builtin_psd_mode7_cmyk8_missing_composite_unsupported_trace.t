#!/bin/sh
# Verify layer-marked mode7 CMYK8 PSD is deterministically rejected as unsupported
...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_mode7_cmyk8_missing_composite_marker.psd"
