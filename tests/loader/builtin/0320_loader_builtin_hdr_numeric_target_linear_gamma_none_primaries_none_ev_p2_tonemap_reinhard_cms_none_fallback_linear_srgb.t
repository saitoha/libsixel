...
SIXEL_HDR_CASE_ID='020'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=020 target=linear gamma=none primaries=none ev=2 tonemap=reinhard cms=none fallback=linear-srgb'
