/* Fix the decoded RGB plane and transparency mask for ALPH filter 3. */

#include "loader_builtin_memory_test_common.h"

int
test_loader_0148_loader_builtin_webp_alph_filter3_numeric(int argc,
                                                           char **argv)
{
    ...
    return edge_expect_fixture_rgb_mask_digests(
        "WebP ALPH filter 3",
        "/tests/data/inputs/formats/webp-vp8-alpha-snake64-filter3.webp",
        &options,
        64,
        64,
        1,
