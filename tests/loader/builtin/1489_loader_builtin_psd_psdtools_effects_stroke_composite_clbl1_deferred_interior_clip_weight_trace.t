...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - \
            "effects/stroke-composite did not enter clbl=1 deferred interior path"
        exit 0
        ;;
esac
...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - \
            "effects/stroke-composite missed deferred gradient overlay apply"
        exit 0
        ;;
esac
...
echo "ok" 1 - \
    "effects/stroke-composite keeps clbl=1 deferred interior suppression contract"
exit 0
