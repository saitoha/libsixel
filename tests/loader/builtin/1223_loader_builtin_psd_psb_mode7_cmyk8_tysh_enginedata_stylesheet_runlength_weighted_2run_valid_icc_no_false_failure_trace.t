#!/bin/sh
# Verify PSB mode7 TySh weighted run-length fixture avoids false failure trace on valid ICC.
...
input_psd="${TOP_SRCDIR}/tests/data/inputs/formats/snake16_psb_mode7_cmyk8_missing_composite_multilayer_nonpixel_nopixel_tysh_enginedata_fillcolor_stylesheet_runlength_weighted_2run_valid_icc_profile.psd"
trace_log=''
command_status=0
...
echo "ok" 1 - "PSB mode7 TySh weighted run-length valid ICC avoids false failure trace"
exit 0
