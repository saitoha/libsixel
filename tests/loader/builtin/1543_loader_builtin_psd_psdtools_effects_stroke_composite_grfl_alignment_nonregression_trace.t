...
case "${diag_line}" in
    *FX_GRFL_ALIGN_SEM*) ;;
    *)
        echo "not ok" 1 - "effects/stroke-composite missed GrFl alignment"
        exit 0
        ;;
esac
...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - \
            "effects/stroke-composite lost deferred GrFl coverage/gate split"
        exit 0
        ;;
esac

echo "ok" 1 - "effects/stroke-composite keeps GrFl alignment trace contract"
exit 0
