...
input_psd="${TOP_BUILDDIR}/tests/data/inputs/formats/snake16_psb_cmyk32_missing_composite_multilayer_normal_high_offset_xxlarge_layer_info_end_overrun.psd"
...
case "${trace_log}" in
    *"builtin PSD: malformed PSB layer info length"*)
        echo "ok" 1 - "PSB mode4 CMYK32 xxlarge high-offset layer-info-end overrun keeps dedicated malformed trace"
        ;;
    *)
        echo "not ok" 1 - "PSB mode4 CMYK32 xxlarge high-offset layer-info-end overrun trace is missing"
        exit 0
        ;;
esac
