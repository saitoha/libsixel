...
SIXEL_HDR_CASE_ID='066'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=066 target=linear gamma=2.2 primaries=none ev=2 tonemap=none cms=auto fallback=linear-srgb'
