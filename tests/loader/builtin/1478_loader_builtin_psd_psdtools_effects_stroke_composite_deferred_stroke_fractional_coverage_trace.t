...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - \
            "effects/stroke-composite missing FX_DEFERRED_STROKE_CLIPPED"
        exit 0
        ;;
esac
...
case "${diag_line}" in
    ...
    *)
        echo "not ok" 1 - \
            "effects/stroke-composite missing FX_DEFERRED_STROKE_FRACTIONAL_SIL"
        exit 0
        ;;
esac

echo "ok" 1 - \
    "effects/stroke-composite keeps deferred fractional stroke code contract"
exit 0
