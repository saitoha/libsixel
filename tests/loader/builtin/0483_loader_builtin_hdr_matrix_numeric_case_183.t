...
SIXEL_HDR_CASE_ID='183'
SIXEL_HDR_CASE_LABEL='hdr matrix numeric case=183 target=gamma gamma=2.2 primaries=bt2020 ev=0 tonemap=reinhard cms=auto fallback=srgb'
