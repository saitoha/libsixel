...
${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" -A composite -Llibwebp:cms_engine=auto! -S "${input_webp}" >"${out_default_cms}" || {
...
${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" -A composite -Llibwebp:cms_engine=none! -S -B#fff "${input_webp}" >"${out_white}" || {
