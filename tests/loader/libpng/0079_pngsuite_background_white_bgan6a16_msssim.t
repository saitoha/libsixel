...
#   magick images/pngsuite/background/bgan6a16.png -colorspace RGB -background "#fff" -alpha remove -alpha off -colorspace sRGB -depth 8 \
...
echo "ok" 1 - "background_white background/bgan6a16.png"
exit 0
