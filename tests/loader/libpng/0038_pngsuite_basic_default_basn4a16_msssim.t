...
#   magick images/pngsuite/basic/basn4a16.png -colorspace RGB -background "#000" -alpha remove -alpha off -colorspace sRGB -depth 8 \
...
echo "ok" 1 - "basic_default basic/basn4a16.png"
exit 0
