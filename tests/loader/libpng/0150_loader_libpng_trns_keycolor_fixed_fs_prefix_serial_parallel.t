#!/bin/sh
# Verify fixed FS serial keeps keycolor header for a tRNS keycolor sample.
...
case "${output_six_text}" in
    *"$(printf '\033')P0;1q"*)
        echo "ok 1 - fixed fs serial keeps keycolor header"
        ;;
    *)
        echo "not ok 1 - fixed fs serial lost keycolor header"
        ;;
esac
