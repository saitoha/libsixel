#!/bin/sh
# TAP test: libpng loader colormgmt parity (nolcms, cms=1) for rgb/img_rgb_icc1_srgb0_chrm0_gama0.png
...
output_six="${ARTIFACT_LOCAL_DIR}/img_rgb_icc1_srgb0_chrm0_gama0_libpng_nolcms_enable_cms1.six"
...
echo "ok" 1 - "libpng colormgmt (nolcms, cms=1) matches reference: rgb/img_rgb_icc1_srgb0_chrm0_gama0.png"
exit 0
