...
#   magick images/pngsuite/basic/basn6a08.png -colorspace RGB -background "#000" -alpha remove -alpha off -colorspace sRGB -crop 16x16+8+8 +repage -depth 8 \
...
echo "ok" 1 - "basic_cropped basic/basn6a08.png"
exit 0
