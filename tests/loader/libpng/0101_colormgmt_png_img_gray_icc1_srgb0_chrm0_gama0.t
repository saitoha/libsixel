#!/bin/sh
# TAP test: libpng loader colormgmt parity for gray/img_gray_icc1_srgb0_chrm0_gama0.png
...
echo "ok" 1 "libpng colormgmt matches reference: gray/img_gray_icc1_srgb0_chrm0_gama0.png"
exit 0
