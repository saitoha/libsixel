#!/bin/sh
# TAP test: libpng loader colormgmt parity (nolcms, cms=1) for idx/img_idx_icc0_srgb1_chrm0_gama1.png
...
output_six="${ARTIFACT_LOCAL_DIR}/img_idx_icc0_srgb1_chrm0_gama1_libpng_nolcms_enable_cms1.six"
...
echo "ok" 1 - "libpng colormgmt (nolcms, cms=1) matches reference: idx/img_idx_icc0_srgb1_chrm0_gama1.png"
exit 0
