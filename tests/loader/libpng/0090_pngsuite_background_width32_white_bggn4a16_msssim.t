...
#   magick images/pngsuite/background/bggn4a16.png -colorspace RGB -background "#fff" -alpha remove -alpha off -colorspace sRGB -resize 32x -depth 8 \
...
output_sixel="${TMPDIR:-/tmp}/libsixel-${0##*/}-$$-bggn4a16.sixel"
...
echo "ok" 1 - "background_width32_white background/bggn4a16.png"
exit 0
