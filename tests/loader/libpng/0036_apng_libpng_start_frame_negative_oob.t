#!/bin/sh
# TAP test: libpng APNG negative out-of-range start frame returns an error.
...
${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" --env SIXEL_TRACE_TOPIC=encode_handoff,apng_decode,lifecycle --start-frame=-999 \
    -Llibpng! -S \
