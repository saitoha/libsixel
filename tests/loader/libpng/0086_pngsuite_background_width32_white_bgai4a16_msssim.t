...
#   magick images/pngsuite/background/bgai4a16.png -colorspace RGB -background "#fff" -alpha remove -alpha off -colorspace sRGB -resize 32x -depth 8 \
...
echo "ok" 1 - "background_width32_white background/bgai4a16.png"
exit 0
