...
#   magick images/pngsuite/background/bgbn4a08.png -colorspace RGB -background "#fff" -alpha remove -alpha off -colorspace sRGB -depth 8 \
...
echo "ok" 1 - "background_white background/bgbn4a08.png"
exit 0
