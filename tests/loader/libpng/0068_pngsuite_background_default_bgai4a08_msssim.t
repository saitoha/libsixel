...
#   magick images/pngsuite/background/bgai4a08.png -colorspace RGB -background "#000" -alpha remove -alpha off -colorspace sRGB -depth 8 \
...
echo "ok" 1 - "background_default background/bgai4a08.png"
exit 0
