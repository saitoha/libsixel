#!/bin/sh
# TAP test: coregraphics loader keeps MS-SSIM baseline for multi-size ICO input.
...
output_sixel="${ARTIFACT_LOCAL_DIR}/coregraphics_ico_multisize.six"
...
echo "ok" 1 "coregraphics keeps MS-SSIM baseline for multi-size ICO input"
exit 0
