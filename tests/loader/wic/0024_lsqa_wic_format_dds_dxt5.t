#!/bin/sh
# Verify WIC DDS DXT5 decoding quality with an MS-SSIM baseline.
...
test "${lsqa_run_status:-0}" -eq 0 && {
    echo "ok" 1 - "wic dds dxt5 quality meets baseline"
    exit 0
}
...
echo "not ok" 1 - "wic dds dxt5 quality regressed"
