...
if {
    tap_log '[test1] invalid option handling'
    ...
    # Validate assorted invalid option combinations.
    ...
    expect_failure '-%'
    expect_failure -m "${TMP_DIR}/invalid_filename" \
        "${TOP_SRCDIR}/images/snake.jpg"
    ...
    tap_ok 1 'invalid option handling'
else
    tap_not_ok 1 'invalid option handling' \
