...
if run_img2sixel -L gdk-pixbuf2! -ldisable "${input_gif}" >"${output_sixel}"; then
    pass ${case_id} "gdk-pixbuf2 GIF decode respects loop disable"
else
    fail ${case_id} "gdk-pixbuf2 GIF decode with loop disable failed"
fi
