#!/bin/sh
# TAP test: coregraphics loader keeps MS-SSIM baseline for palette4 TGA input.
...
run_img2sixel -L coregraphics! "${image_path}" >"${output_sixel}" || {
    fail 1 "coregraphics failed to decode palette4 TGA input"
    exit 0
}
...
pass 1 "coregraphics keeps MS-SSIM baseline for palette4 TGA input"
exit 0
