#!/bin/sh
# TAP test: coregraphics loader rejects DDS DXT1 input safely.
...
run_img2sixel -L coregraphics! "${image_path}" >/dev/null && {
    fail 1 "coregraphics unexpectedly decoded DDS DXT1 input"
    exit 0
}

pass 1 "coregraphics rejects DDS DXT1 input safely"
exit 0
