#!/bin/sh
# TAP test: coregraphics loader keeps MS-SSIM baseline for RGB TGA input.
...
output_sixel="${ARTIFACT_LOCAL_DIR}/coregraphics_tga_rgb.six"

run_img2sixel -L coregraphics! "${image_path}" >"${output_sixel}" || {
    fail 1 "coregraphics failed to decode RGB TGA input"
    exit 0
}
...
pass 1 "coregraphics keeps MS-SSIM baseline for RGB TGA input"
exit 0
