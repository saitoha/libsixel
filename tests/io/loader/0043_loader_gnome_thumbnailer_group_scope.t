...
work_dir="${ARTIFACT_LOCAL_DIR}/gnome_group_scope"
marker_file="${work_dir}/group_scope.marker"
...
cat >"${thumb_dir}/group-scope.thumbnailer" <<'EOS2'
[Wrong Group]
TryExec=missing-command
Exec=missing-command %i %o
MimeType=image/png;
