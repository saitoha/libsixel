...
run_case_tap "staticcheck-makefile-generated-pairs" \
    "$src_root/tests/_static/sh/staticcheck-makefile-generated-pairs.sh" \
    "$src_root" || fail_and_exit $?
...
run_case_tap "staticcheck-suboption-registry" \
    "$src_root/tests/_static/sh/staticcheck-suboption-registry.sh" \
    "$src_root" || fail_and_exit $?
...
run_case_tap "staticcheck-filter-vtbl-boundary" \
    "$src_root/tests/_static/sh/staticcheck-filter-vtbl-boundary.sh" \
    "$src_root" || fail_and_exit $?
...
run_case_tap "staticcheck-big-endian-compat" \
    "$src_root/tests/_static/sh/staticcheck-big-endian-compat.sh" \
    "$src_root" || fail_and_exit $?
...
run_case_tap "staticcheck-experimental-full-tests" \
    "$src_root/tests/_static/sh/staticcheck-experimental-full-tests.sh" \
    "$src_root" || fail_and_exit $?
