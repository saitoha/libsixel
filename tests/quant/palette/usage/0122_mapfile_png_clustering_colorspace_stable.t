#!/bin/sh
# Verify clustering colorspace does not reinterpret PNG mapfile palettes.
set -eux
...
actual_palette=$(
    ${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" \
        -X oklab -m "${mapfile_png}" -M pal:- -o /dev/null "${input_image}"
) || {
...
echo "ok" 1 - "PNG mapfile is stable under clustering colorspace"
exit 0
