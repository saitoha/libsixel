...
palette_png="${TOP_SRCDIR}/images/pngsuite/basic/basn3p08.png"
input_png="${TOP_SRCDIR}/tests/data/inputs/snake_64.png"
target_sixel="${ARTIFACT_LOCAL_DIR}/mapfile-pal8.sixel"

run_img2sixel -m "${palette_png}" "${input_png}" \
        >"${target_sixel}" || {
    echo "not ok" 1 "PAL8 PNG palette mapfile rejected"
    exit 0
}

echo "ok" 1 "PAL8 PNG palette mapfile accepted"
