#!/bin/sh
# Verify the sample target reaches the palette sampling consumer.
...
output_sixel="${ARTIFACT_LOCAL_DIR}/0181-sample-target-$$.six"
...
echo "ok 1 - sample target preserves image output"
exit 0
