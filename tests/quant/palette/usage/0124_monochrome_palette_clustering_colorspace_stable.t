#!/bin/sh
# Verify clustering colorspace does not reinterpret monochrome palettes.
set -eux
...
actual_palette=$(
    ${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" \
        -X oklab -e -M pal:- -o /dev/null "${input_image}"
) || {
...
echo "ok" 1 - "monochrome palette is stable under clustering colorspace"
exit 0
