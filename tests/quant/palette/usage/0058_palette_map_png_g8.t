...
palette_png="${images_dir}/pngsuite/basic/basn0g08.png"
input_png="${top_srcdir}/tests/data/inputs/snake_64.png"
target_sixel="${output_dir}/mapfile-g8.sixel"
...
if run_img2sixel -m "${palette_png}" "${input_png}" \
        >"${target_sixel}"; then
    pass 1 "G8 PNG palette mapfile accepted"
else
    fail 1 "G8 PNG palette mapfile rejected"
fi
