#!/bin/sh
# Validate downscale 80pct scaling with hamming resampling.
#
...
if lsqa_run_benchmark "${reference_image}" "${output_sixel}"         "hamming-downscale_80pct" "${artifact_dir}" "${lsqa_floor}"; then
