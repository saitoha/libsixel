...
# Build and run the load filter unit tests using the in-tree libtool archive.
...
SRC="${TOP_SRCDIR}/tests/filter/filter_load_tests.c"
OBJ="${ARTIFACT_ROOT:-.}/filter_load_tests.lo"
BIN="${ARTIFACT_ROOT:-.}/filter_load_tests"
