...
# Build and run the resize filter unit tests using the in-tree libtool
...
SRC="${TOP_SRCDIR}/tests/filter/filter_resize_tests.c"
OBJ="${ARTIFACT_ROOT:-.}/filter_resize_tests.lo"
BIN="${ARTIFACT_ROOT:-.}/filter_resize_tests"
