...
# Build and run the filter unit tests using the in-tree libtool archive. The
# TAP output comes from the test binary itself.
...
SRC="${TOP_SRCDIR}/tests/filter/filter_tests.c"
OBJ="${ARTIFACT_ROOT:-.}/filter_tests.lo"
BIN="${ARTIFACT_ROOT:-.}/filter_tests"
