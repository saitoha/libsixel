...
# Build and run the final-merge filter unit tests using the in-tree libtool
...
SRC="${TOP_SRCDIR}/tests/filter/filter_final_merge_tests.c"
OBJ="${ARTIFACT_ROOT:-.}/filter_final_merge_tests.lo"
BIN="${ARTIFACT_ROOT:-.}/filter_final_merge_tests"
