...
# Build and run the sample filter unit tests using the in-tree libtool
...
SRC="${TOP_SRCDIR}/tests/filter/filter_sample_tests.c"
OBJ="${ARTIFACT_ROOT:-.}/filter_sample_tests.lo"
BIN="${ARTIFACT_ROOT:-.}/filter_sample_tests"
