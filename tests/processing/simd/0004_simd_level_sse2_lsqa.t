#!/bin/sh
# Validate SIXEL_SIMD_LEVEL=sse2 path with scale+colorspace work and LSQA.
...
reference_image="${ARTIFACT_LOCAL_DIR}/snake_63_ref_sse2.png"
output_sixel="${ARTIFACT_LOCAL_DIR}/snake_63_sse2.six"
lsqa_run_status=0
lsqa_err=""
...
test "${lsqa_run_status}" -eq 0 && {
    pass 1 "SIXEL_SIMD_LEVEL=sse2 reached MS-SSIM 0.99"
    exit 0
}
...
test "${lsqa_run_status}" -eq 0 && {
    pass 1 "SIXEL_SIMD_LEVEL=sse2 reached MS-SSIM 0.98"
    exit 0
}

fail 1 "SIXEL_SIMD_LEVEL=sse2 fell below MS-SSIM 0.98: ${lsqa_err}"
exit 0
