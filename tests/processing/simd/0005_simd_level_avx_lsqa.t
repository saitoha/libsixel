...
reference_image="${ARTIFACT_LOCAL_DIR}/snake_63_ref_avx.png"
...
test "${lsqa_run_status}" -eq 0 && {
    pass 1 "SIXEL_SIMD_LEVEL=avx reached MS-SSIM 0.99"
    exit 0
}
...
test "${lsqa_run_status}" -eq 0 && {
    pass 1 "SIXEL_SIMD_LEVEL=avx reached MS-SSIM 0.98"
    exit 0
}

fail 1 "SIXEL_SIMD_LEVEL=avx fell below MS-SSIM 0.98: ${lsqa_err}"
exit 0
