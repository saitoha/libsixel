...
#if defined(__PCC__)
int
test_or_dec_0041(int argc, char **argv)
{
    /*
...
#else
static unsigned char g_or_legacy_zero_payload[] =
    "\033P7;5q\"1;1;2;1"
    "#0;2;25;50;75"
    "#1;2;100;0;0"
    "#2;2;0;100;0"
...
test_or_dec_0041(int argc, char **argv)
{
    ...
    status = sixel_decode(g_or_legacy_zero_payload,
                          (int)(sizeof(g_or_legacy_zero_payload) - 1U),
                          &pixels,
                          &width,
                          &height,
                          &palette,
