#!/bin/sh
# Pin the existing FHEDT resolution environment contract.
...
test "${trace#*LSXLUT1|policy=fhedt|*resolution=128*}" != "${trace}" || {
    echo "not ok" 1 - "FHEDT resolution environment was not consumed"
    exit 0
}

echo "ok" 1 - "FHEDT resolution environment remains effective"
exit 0
