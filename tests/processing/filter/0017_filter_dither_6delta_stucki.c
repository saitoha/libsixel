...
test_filter_0017_filter_dither_6delta_stucki(int argc, char **argv)
{
     ...
     * retained error -120 and Stucki's 1/6 weight produce 110 here;
     * diffusing the palette error -125 would produce 109 instead.
     */
    if (pixel[3] != 110u) {
        fprintf(stderr,
                "stucki neighbor is %u instead of retained-error value 110\n",
