#!/bin/sh
# TAP test covering positional 8-bit A dither in sRGB gamma space.
#
# Flow:
...
run_img2sixel -d a_dither -y raster -W gamma -o "${output_sixel}" \
    "${input_image}" || {
    fail 1 "positional 8-bit a_dither gamma lsqa failed"
    exit 0
}
...
test "${lsqa_run_status:-0}" -eq 0 && {
    pass 1 "positional 8-bit a_dither gamma lsqa passed"
    exit 0
}
