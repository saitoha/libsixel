#!/bin/sh
# TAP test covering positional float32 bluenoise in DIN99d space.
#
# Flow:
...
run_img2sixel -d bluenoise -y raster -W din99d -o "${output_sixel}" "${input_image}" || {
...
test "${lsqa_run_status:-0}" -eq 0 && {
    echo "ok" 1 - "positional float32 bluenoise din99d lsqa passed"
    exit 0
}
