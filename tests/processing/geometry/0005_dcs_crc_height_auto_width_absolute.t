...
source_sixel="${ARTIFACT_LOCAL_DIR}/dcs-height-auto-absolute-input.sixel"
scaled_sixel="${ARTIFACT_LOCAL_DIR}/dcs-height-auto-absolute-output.sixel"
...
${SIXEL_RUNTIME-} "${IMG2SIXEL_PATH}" -=1 -rne -hauto -w12 \
