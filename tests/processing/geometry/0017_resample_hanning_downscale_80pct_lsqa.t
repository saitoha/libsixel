#!/bin/sh
# Validate downscale 80pct scaling with hanning resampling.
#
...
test "${lsqa_run_status:-0}" -eq 0 && {
    echo "ok" 1 - "hanning downscale 80pct lsqa passed"
    exit 0
}
...
echo "not ok" 1 - "hanning downscale 80pct lsqa failed"
