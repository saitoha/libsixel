...
output_sixel="${artifact_dir}/cluster-oklab-work-oklab.six"

require_file "${input_image}"

if run_img2sixel -t rgb -X oklab -W oklab -o "${output_sixel}"     "${input_image}"     2>>"${log_file}"; then
    :
else
...
if [ -z "${lsqa_run_status-}" ]; then
    pass 1 "clustering oklab working oklab lsqa passed"
