                                 ...
                                 size_t *out_size)
{
    ...
    static unsigned char const webp_vp8_header[30] = {
        ...
        0xd0u, 0x11u, 0x00u, 0x9du, 0x01u, 0x2au, 0x40u, 0x00u,
        0x40u, 0x00u
    };
    ...
    static unsigned char const webp_vp8x_vp8_header[48] = {
        'R', 'I', 'F', 'F', 0x28u, 0x00u, 0x00u, 0x00u,
        'W', 'E', 'B', 'P', 'V', 'P', '8', 'X',
        0x0au, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 'V', 'P', '8', ' ', 0x0au, 0x00u, 0x00u, 0x00u,
        0xd0u, 0x11u, 0x00u, 0x9du, 0x01u, 0x2au, 0x40u, 0x00u,
        0x40u, 0x00u
    };
    static unsigned char const webp_vp8x_vp8l_header[54] = {
    ...
    static unsigned char const webp_vp8_token2_header[96] = {
        0x52u, 0x49u, 0x46u, 0x46u, 0xbau, 0x3bu, 0x00u, 0x00u,
        0x57u, 0x45u, 0x42u, 0x50u, 0x56u, 0x50u, 0x38u, 0x20u,
        0x68u, 0x3bu, 0x00u, 0x00u, 0xb0u, 0x8eu, 0x00u, 0x9du,
        0x01u, 0x2au, 0xb0u, 0x00u, 0x90u, 0x00u, 0x00u, 0x07u,
        0x08u, 0x85u, 0x85u, 0x88u, 0x85u, 0x84u, 0x88u, 0x42u,
        0x02u, 0x02u, 0x75u, 0xbau, 0x4au, 0xfau, 0x9fu, 0x51u,
        0xf9u, 0x3du, 0xf8u, 0xddu, 0xf2u, 0x27u, 0xc7u, 0xbdu,
        0x3cu, 0xfau, 0x2fu, 0xedu, 0xbfu, 0xacu, 0xfdu, 0x9bu,
        0xf2u, 0x3du, 0xd3u, 0x5eu, 0x45u, 0x9cu, 0xe3u, 0xffu,
        0x37u, 0xfcu, 0x3fu, 0xedu, 0xb7u, 0xf8u, 0x0fu, 0x7du,
        0xffu, 0xf6u, 0x7fu, 0xbdu, 0xfbu, 0x84u, 0xfcu, 0xc5u,
        0xffu, 0x77u, 0xfbu, 0x3fu, 0xefu, 0xffu, 0xd0u, 0x1fu
    };
    static unsigned char const webp_vp8_token4_header[96] = {
        0x52u, 0x49u, 0x46u, 0x46u, 0xc4u, 0x3bu, 0x00u, 0x00u,
        0x57u, 0x45u, 0x42u, 0x50u, 0x56u, 0x50u, 0x38u, 0x20u,
        0x72u, 0x3bu, 0x00u, 0x00u, 0xb0u, 0x8eu, 0x00u, 0x9du,
        0x01u, 0x2au, 0xb0u, 0x00u, 0x90u, 0x00u, 0x00u, 0x07u,
        0x08u, 0x85u, 0x85u, 0x88u, 0x85u, 0x84u, 0x88u, 0x82u,
        0x02u, 0x02u, 0x75u, 0xbau, 0x4au, 0xfau, 0x9fu, 0x51u,
        0xf9u, 0x3du, 0xf8u, 0xddu, 0xf2u, 0x27u, 0xc7u, 0xbdu,
        0x3cu, 0xfau, 0x2fu, 0xedu, 0xbfu, 0xacu, 0xfdu, 0x9bu,
        0xf2u, 0x3du, 0xd3u, 0x5eu, 0x45u, 0x9cu, 0xe3u, 0xffu,
    ...
    static unsigned char const webp_vp8_token8_header[96] = {
        0x52u, 0x49u, 0x46u, 0x46u, 0xd4u, 0x3bu, 0x00u, 0x00u,
        0x57u, 0x45u, 0x42u, 0x50u, 0x56u, 0x50u, 0x38u, 0x20u,
        0x82u, 0x3bu, 0x00u, 0x00u, 0xb0u, 0x8eu, 0x00u, 0x9du,
        0x01u, 0x2au, 0xb0u, 0x00u, 0x90u, 0x00u, 0x00u, 0x07u,
        0x08u, 0x85u, 0x85u, 0x88u, 0x85u, 0x84u, 0x88u, 0xc2u,
        0x02u, 0x02u, 0x75u, 0xbau, 0x4au, 0xfau, 0x9fu, 0x51u,
        0xf9u, 0x3du, 0xf8u, 0xddu, 0xf2u, 0x27u, 0xc7u, 0xbdu,
        0x3cu, 0xfau, 0x2fu, 0xedu, 0xbfu, 0xacu, 0xfdu, 0x9bu,
        0xf2u, 0x3du, 0xd3u, 0x5eu, 0x45u, 0x9cu, 0xe3u, 0xffu,
    ...
    static unsigned char const webp_vp8x_alpha_vp8_header[114] = {
        0x52u, 0x49u, 0x46u, 0x46u, 0x6au, 0x00u, 0x00u, 0x00u,
        0x57u, 0x45u, 0x42u, 0x50u, 0x56u, 0x50u, 0x38u, 0x58u,
        0x0au, 0x00u, 0x00u, 0x00u, 0x10u, 0x00u, 0x00u, 0x00u,
        0x05u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x41u, 0x4cu,
        0x50u, 0x48u, 0x07u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x80u, 0xffu, 0x00u, 0x00u, 0x00u, 0x56u, 0x50u,
        0x38u, 0x20u, 0x3cu, 0x00u, 0x00u, 0x00u, 0xb0u, 0x01u,
        0x00u, 0x9du, 0x01u, 0x2au, 0x06u, 0x00u, 0x01u, 0x00u,
        0x02u, 0x00u, 0x34u, 0x25u, 0xa8u, 0x02u, 0x74u, 0x00u,
        0xddu, 0x03u, 0xafu, 0x00u, 0x00u, 0xfdu, 0x8cu, 0x93u,
        0x2bu, 0x36u, 0x84u, 0x1au, 0x77u, 0xffu, 0x26u, 0xd4u,
        0x82u, 0xfcu, 0xceu, 0xffu, 0x59u, 0x2fu, 0xffu, 0xebu,
        0x80u, 0xffu, 0xb3u, 0x9eu, 0xa5u, 0xf3u, 0x3bu, 0xfdu,
        0x64u, 0xbfu, 0xbdu, 0x7fu, 0x5cu, 0x2du, 0xaeu, 0x37u,
        0x40u, 0x00u
    };
    size_t target_size;
    ...
    case FUZZ_FORCE_FORMAT_WEBP:
        if (target_size < sizeof(webp_vp8x_alpha_vp8_header)) {
            target_size = sizeof(webp_vp8x_alpha_vp8_header);
        }
        break;
    ...
    case FUZZ_FORCE_FORMAT_WEBP:
        ...
        switch (webp_variant) {
        case 0u:
            webp_header = webp_vp8_header;
            webp_header_size = sizeof(webp_vp8_header);
            break;
        case 1u:
            webp_header = webp_vp8x_vp8_header;
            webp_header_size = sizeof(webp_vp8x_vp8_header);
            break;
        case 2u:
            webp_header = webp_vp8l_header;
            webp_header_size = sizeof(webp_vp8l_header);
            break;
        case 3u:
            webp_header = webp_vp8x_vp8l_header;
            webp_header_size = sizeof(webp_vp8x_vp8l_header);
            break;
        case 4u:
            webp_header = webp_vp8_token2_header;
            webp_header_size = sizeof(webp_vp8_token2_header);
            break;
        case 5u:
            webp_header = webp_vp8_token4_header;
            webp_header_size = sizeof(webp_vp8_token4_header);
            break;
        case 6u:
            webp_header = webp_vp8_token8_header;
            webp_header_size = sizeof(webp_vp8_token8_header);
            break;
        case 7u:
