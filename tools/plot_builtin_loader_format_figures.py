...
PIPELINES: dict[str, dict[str, object]] = {
    "sixel": {
        ...
        "tests": {
            ...
            "SIX-05": ["tests/processing/decoder/0016_decoder_parallel_fallback_keeps_image_clean.t"],
        },
    },
    "netpbm": {
    ...
    "png": {
        ...
        "stages": [
            ...
            stage("PNG-05", "ANIMATE", "Rebuild and composite APNG frames",
                  ...
                  ("validate sequence, decode IDAT/fdAT frame images",
                   "apply blend/dispose and loop/start-frame policy"), "decode"),
        ...
        "tests": {
            ...
            "PNG-04": ["tests/loader/builtin/0055_builtin_png_embedded_icc_matches_reference_pnm.t"],
            "PNG-05": ["tests/loader/builtin/0033_apng_builtin_dispose_previous.t"],
    ...
    "jpeg": {
        ...
        "tests": {
            "JPG-01": ["tests/loader/builtin/0119_loader_builtin_jpeg_rgb_8bit_seq444_r0_expected_lsqa.t"],
            "JPG-02": ["tests/loader/builtin/0131_loader_builtin_rejects_arithmetic_jpeg.t"],
            "JPG-03": ["tests/loader/builtin/0116_loader_builtin_jpeg_rgb_16bit_lossless_r0_decode.t"],
            "JPG-04": ["tests/loader/builtin/0123_loader_builtin_jpeg_ycck_8bit_seq444_r0_expected_lsqa.t"],
            "JPG-05": ["tests/loader/builtin/0056_builtin_jpeg_embedded_icc_matches_reference_pnm.t"],
    ...
    "hdr": {
        ...
        "tests": {
            ...
            "HDR-03": ["tests/loader/builtin/0670_loader_builtin_hdr_xyze_numeric.t"],
    ...
    "psd": {
        ...
        "tests": {
            ...
            "PSD-02": ["tests/loader/builtin/0597_loader_builtin_psd_mode7_rgb16_zip_pred_decode.t"],
            ...
            "PSD-05": ["tests/loader/builtin/0057_builtin_psd_embedded_icc_matches_reference_pnm.t"],
    ...
    "webp": {
        ...
        "tests": {
            ...
            "WBP-02": ["tests/loader/builtin/1647_loader_builtin_webp_vp8_static_quality_snake64_msssim.t"],
            "WBP-03": ["tests/loader/builtin/1931_loader_builtin_webp_vp8l_transform_subsample_quality_msssim.t"],
            "WBP-04": ["tests/loader/builtin/1669_loader_builtin_webp_vp8_alpha_static_quality_msssim.t"],
            "WBP-05": ["tests/loader/builtin/1725_loader_builtin_webp_animation_lossy_alpha_quality_msssim.t"],
    ...
    "pic": {
        ...
        "tests": {
            ...
            "PIC-02": ["tests/loader/builtin/0694_loader_builtin_pic_chained_packets_decode.t"],
            "PIC-03": ["tests/loader/builtin/0689_loader_builtin_pic_raw_rgb_decode.t"],
            "PIC-04": ["tests/loader/builtin/0693_loader_builtin_pic_rle_mixed_ext_count_decode.t"],
