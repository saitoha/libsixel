...
| DP-10 | OR-mode reconstruction returns an opaque direct result where every pixel is painted. | [tests/processing/decoder/0022_decoder_ormode_dequantize_opaque.t](../../tests/processing/decoder/0022_decoder_ormode_dequantize_opaque.t) |
