...
- [Delta encoding (6delta)](functionality/delta-encoding.md) explains `-Z` and `-Y`, retained display colors, threshold and palette comparisons, partial-update APIs, invalidation, CPU/GPU scope, and test coverage.
