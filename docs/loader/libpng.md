...
| LP-32 | PREVIOUS restores both occupied colors and coverage after a frame replaces one pixel and clears another. | [tests/loader/libpng/0257_libpng_occupied_previous.t](../../tests/loader/libpng/0257_libpng_occupied_previous.t) |
| LP-33 | Corrupting only an original fdAT CRC rejects the APNG before callbacks; the otherwise identical valid stream succeeds. | [tests/loader/libpng/0258_libpng_fdat_crc.t](../../tests/loader/libpng/0258_libpng_fdat_crc.t) |
| LP-34 | A structurally valid static PNG with an invalid raster filter returns a libpng raster error without a callback; a subsequent valid load succeeds. | [tests/loader/libpng/0259_libpng_static_longjmp.t](../../tests/loader/libpng/0259_libpng_static_longjmp.t) |
| LP-35 | A raster error in the second APNG frame unwinds through libpng and returns the error after exactly one callback, without static/backend fallback. | [tests/loader/libpng/0260_libpng_apng_longjmp.t](../../tests/loader/libpng/0260_libpng_apng_longjmp.t) |
