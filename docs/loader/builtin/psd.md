...
| PSD-06 | An RGB8 alpha document produces fixed uncomposited RGB/mask bytes and fixed RGB bytes after explicit white composition. | [tests/loader/builtin/2016_loader_builtin_psd_rgb8_alpha_mask_digest.t](../../../tests/loader/builtin/2016_loader_builtin_psd_rgb8_alpha_mask_digest.t), [tests/loader/builtin/2017_loader_builtin_psd_rgb8_alpha_white_digest.t](../../../tests/loader/builtin/2017_loader_builtin_psd_rgb8_alpha_white_digest.t) |
| PSD-07 | CMYK16 and Lab32 ZIP-prediction documents preserve their native typed output and fixed representative samples. | [tests/loader/builtin/2018_loader_builtin_psd_cmyk16_zip_pred_numeric.t](../../../tests/loader/builtin/2018_loader_builtin_psd_cmyk16_zip_pred_numeric.t), [tests/loader/builtin/2019_loader_builtin_psd_lab32_zip_pred_numeric.t](../../../tests/loader/builtin/2019_loader_builtin_psd_lab32_zip_pred_numeric.t) |
| PSD-08 | Every one of the 27 recognized layer blend keys produces a fixed exact RGB result for the same two one-pixel layers. | [tests/loader/builtin/2024_loader_builtin_psd_blend_modes_numeric.t](../../../tests/loader/builtin/2024_loader_builtin_psd_blend_modes_numeric.t) |
| PSD-09 | Clipping reconstruction produces the fixed complete RGB buffer for a multilayer document. | [tests/loader/builtin/2025_loader_builtin_psd_clipping_digest.t](../../../tests/loader/builtin/2025_loader_builtin_psd_clipping_digest.t) |
| PSD-10 | Raster-mask reconstruction produces the fixed complete RGB buffer for a multilayer document. | [tests/loader/builtin/2026_loader_builtin_psd_mask_digest.t](../../../tests/loader/builtin/2026_loader_builtin_psd_mask_digest.t) |
| PSD-11 | Representative layer-effect reconstruction produces the fixed complete RGB buffer. | [tests/loader/builtin/2027_loader_builtin_psd_effect_digest.t](../../../tests/loader/builtin/2027_loader_builtin_psd_effect_digest.t) |
| PSD-12 | Allocation failures while parsing and reconstructing a multilayer effect document release all allocations without emitting an invalid frame. | [tests/loader/builtin/2034_loader_builtin_psd_effect_allocation_failures.t](../../../tests/loader/builtin/2034_loader_builtin_psd_effect_allocation_failures.t) |
...
| PSD-91 | A PSB layer-info field containing `UINT64_MAX` is rejected without a frame callback. | [tests/loader/builtin/2020_loader_builtin_psb_layer_info_u64max_reject.t](../../../tests/loader/builtin/2020_loader_builtin_psb_layer_info_u64max_reject.t) |

Coverage audit note: direct owners now fix representative typed samples for RGB16, RGB32, CMYK16, and Lab32 compression paths; complete RGB buffers for builtin ICC, normal layers, clipping, one raster mask, and one layer effect; all 27 recognized blend keys for a fixed two-layer input; exact RGB/mask and white-background alpha behavior; allocation cleanup through one multilayer-effect graph; and selected PSD/PSB structural failures including one 64-bit length extreme. The mode × depth × compression × PSD/PSB matrix remains incomplete, and the direct owners do not exhaust mask parameters, fills, text, vector data, blend-mode opacity/alpha combinations, or effect dialects and parameter combinations.
