...
| --- | --- | --- |
| WBP-02 | Native lossy VP8 decoding produces the fixed complete RGB buffer for the representative key frame. | [tests/loader/builtin/1980_loader_builtin_webp_vp8_digest.t](../../../tests/loader/builtin/1980_loader_builtin_webp_vp8_digest.t) |
| WBP-03 | A representative VP8L stream combining predictor, subtract-green, and meta-Huffman paths with literals and back-references produces the fixed complete RGB buffer. | [tests/loader/builtin/1965_loader_builtin_webp_vp8l_transform_rgb_digest.t](../../../tests/loader/builtin/1965_loader_builtin_webp_vp8l_transform_rgb_digest.t) |
...
| WBP-08 | A VP8 key frame using four token partitions produces the fixed complete RGB buffer. | [tests/loader/builtin/2011_loader_builtin_webp_vp8_token_partitions_digest.t](../../../tests/loader/builtin/2011_loader_builtin_webp_vp8_token_partitions_digest.t) |
| WBP-09 | ALPH filters horizontal, vertical, and gradient reconstruct the same fixed RGB plane and transparency mask. | [tests/loader/builtin/2012_loader_builtin_webp_alph_filter1_numeric.t](../../../tests/loader/builtin/2012_loader_builtin_webp_alph_filter1_numeric.t), [tests/loader/builtin/2013_loader_builtin_webp_alph_filter2_numeric.t](../../../tests/loader/builtin/2013_loader_builtin_webp_alph_filter2_numeric.t), [tests/loader/builtin/2014_loader_builtin_webp_alph_filter3_numeric.t](../../../tests/loader/builtin/2014_loader_builtin_webp_alph_filter3_numeric.t) |
| WBP-10 | A three-frame lossy-alpha animation with subrectangles produces fixed complete canvases after composition. | [tests/loader/builtin/2015_loader_builtin_webp_animation_subrect_digest.t](../../../tests/loader/builtin/2015_loader_builtin_webp_animation_subrect_digest.t) |
| WBP-11 | Cancellation before animation decode and immediately after its first callback both return `SIXEL_INTERRUPTED` without emitting a later frame. | [tests/loader/builtin/2029_loader_builtin_webp_cancel_boundaries.t](../../../tests/loader/builtin/2029_loader_builtin_webp_cancel_boundaries.t) |
| WBP-12 | VP8L color-cache references expand into the fixed complete RGB buffer. | [tests/loader/builtin/2036_loader_builtin_webp_vp8l_color_cache_digest.t](../../../tests/loader/builtin/2036_loader_builtin_webp_vp8l_color_cache_digest.t) |
| WBP-13 | VP8L color-index transform subsampling is reversed into the fixed complete RGB buffer for a stream that reaches that transform. | [tests/loader/builtin/2037_loader_builtin_webp_vp8l_color_index_digest.t](../../../tests/loader/builtin/2037_loader_builtin_webp_vp8l_color_index_digest.t) |
| WBP-14 | An alpha-bearing animation applies the declared ANIM background to produce two fixed complete canvases. | [tests/loader/builtin/2038_loader_builtin_webp_alpha_background_digest.t](../../../tests/loader/builtin/2038_loader_builtin_webp_alpha_background_digest.t) |
| WBP-15 | Allocation failures across animation planning, decode, and composition release all allocations; failure after a callback may retain only a valid frame prefix. | [tests/loader/builtin/2033_loader_builtin_webp_animation_allocation_failures.t](../../../tests/loader/builtin/2033_loader_builtin_webp_animation_allocation_failures.t) |
...
Coverage audit note: direct owners now fix representative VP8 and VP8L RGB output, one multi-partition VP8 stream, all three specified ALPH reconstruction filters, VP8L color-cache and color-index paths, full-frame/subrectangle/alpha-background animation canvases, and animation cancellation/allocation boundaries. The suite still does not exhaust every VP8 macroblock/filter/partition mode, VP8L Huffman/transform nesting, ALPH compression/preprocessing combination, animation blend/dispose/background permutation, or metadata precedence/size-limit combination.
